...
import soot.android.IntentTransformer;
...
//        }
        ...
        // WEI: comment out: LocalPacker.v().transform(jBody);
        UnusedLocalEliminator.v().transform(jBody);
		...
		ConstantPropagatorAndFolder.v().transform(jBody);
        CopyPropagator.v().transform(jBody);
        ...
        if (System.getProperty("inferAndroidApp") != null) {
            IntentTransformer.v().transform(jBody);
        }
