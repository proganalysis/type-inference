...
{
    private transient LinkedList_Entry header = new LinkedList_Entry(null, null, null);
     ...
     */
    public LinkedList(/*@Aliased*/ Collection c) {
	 this();
	 addAll(c);
     }
    ...
    public boolean remove(Object o) {
        if (o==null) {
            for (LinkedList_Entry e = header.next; e != header; e = e.next) {
                if (e.element==null) {
                    remove(e);
                    return true;
                }
     ...
     * @throws NullPointerException if the specified collection is null.
     */
    public boolean addAll(/*@Aliased*/ Collection c) {
     ...
     * @throws NullPointerException if the specified collection is null.
     */
    public boolean addAll(int index, /*@Aliased*/ Collection c) {
	...
	incrementModCount();
        ...
        LinkedList_Entry successor = (index==size ? header : entry(index));
        LinkedList_Entry predecessor = successor.previous;
	for (int i=0; i<numNew; i++) {
            LinkedList_Entry e = new LinkedList_Entry((Object)a[i], successor, predecessor);
            predecessor.next = e;
            predecessor = e;
        }
     ...
     */
    public void clear() {
        LinkedList_Entry e = header.next;
        while (e != header) {
            LinkedList_Entry next = e.next;
    ...
    public Object set(int index, Object element) {
        LinkedList_Entry e = entry(index);
     ...
     */
    private LinkedList_Entry entry(int index) {
        if (index < 0 || index >= size)
            throw new IndexOutOfBoundsException("Index: "+index+
                                                ", Size: "+size);
        LinkedList_Entry e = header;
        if (index < (size >> 1)) {
    ...
    public int lastIndexOf(Object o) {
        int index = size;
        if (o==null) {
            for (LinkedList_Entry e = header.previous; e != header; e = e.previous) {
                index--;
                if (e.element==null)
                    return index;
            }
     ...
     */
    public /*Aliased*/ ListIterator listIterator(int index) {
	return (ListIterator) new LinkedList_ListItr(this, this.header, index);
    }

    // FT: made this method private, because it returns an internal class
    private LinkedList_Entry addBefore(Object o, LinkedList_Entry e) {
	LinkedList_Entry newEntry = new LinkedList_Entry(o, e, e.previous);
    ...
    // FT: clone of addBefore, in which the return type has been changed to void
    // (this method is called by LinkedList_ListItr.add(), which ignored the return value of addBefore()
    void addBefore2(Object o, LinkedList_Entry e) {
	LinkedList_Entry newEntry = new LinkedList_Entry(o, e, e.previous);
	newEntry.previous.next = newEntry;
	newEntry.next.previous = newEntry;
	size++;
    ...
    Object remove(LinkedList_Entry e) {
	if (e == header)
	    throw new NoSuchElementException();
     ...
     */
// FT: clone() generated automatically by our compiler
//    public Object clone() {
...
//        clone.header = new LinkedList_Entry/*E=this.L*/(null, null, null);
//        clone.header.next = clone.header.previous = clone.header;
//        clone.size = 0;
//        clone.setModCount(0);
//
//        // Initialize clone with our elements
//        for (LinkedList_Entry e/*E=this.L*/ = header.next; e != header; e = e.next)
//            clone.add(e.element);
//
//        return clone;
//    }
	...
	Object[] result = new Object /*@NonAliased*/ [size];
        int i = 0;
        for (LinkedList_Entry e = header.next; e != header; e = e.next)
            result[i++] = e.element;
	return result;
	...
	s.defaultReadObject();
        ...
        // Initialize header
        header = new LinkedList_Entry(null, null, null);
        header.next = header.previous = header;

	// Read in all elements in the proper order.
	for (int i=0; i<size; i++)
            addBefore((Object)s.readObject(), header);
    }
}
