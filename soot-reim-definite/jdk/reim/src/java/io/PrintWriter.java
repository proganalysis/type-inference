...
public class PrintWriter extends Writer {
    ...
    public void write(@Readonly char[] buf, int off, int len) {
        throw new RuntimeException("skeleton method");
    }

    public void write(@Readonly char[] buf) {
        throw new RuntimeException("skeleton method");
    }
    ...
    public void print(@Readonly char[] s) {
        throw new RuntimeException("skeleton method");
    }
    ...
    public void println(@Readonly char[] x) {
        throw new RuntimeException("skeleton method");
    }
