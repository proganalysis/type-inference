...
public class innerClassAttr extends attrInfo {
  ...
  public innerClassAttr( String name, int length, 
	...
	classInfoTab = new   innerClassInfo  /*@RepPar*/  [ numInnerClasses ]; //ANA: Analysis correctly figures this class is dead code.

      for (int i = 0; i < numInnerClasses; i++) {
	  classInfoTab[i] = new  /*@RepPar*/  innerClassInfo( dStream, constPoolSec );
      }
    }
