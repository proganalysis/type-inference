...
public RecoveredElement add(Block nestedBlockDeclaration, int bracketBalanceValue) {
	...
	*/
	if (methodDeclaration.declarationSourceEnd > 0
		&& nestedBlockDeclaration.sourceStart
			> methodDeclaration.declarationSourceEnd){
				if (this.parent == null){
					return (/*@OwnPar*/ /*@NoRep*/ RecoveredMethod)this; // ignore
				} else {
	...
	methodBody = new RecoveredBlock(nestedBlockDeclaration, (/*@OwnPar*/ /*@NoRep*/ RecoveredMethod)this, bracketBalanceValue);
	if (nestedBlockDeclaration.sourceEnd == 0) return methodBody;
	return (/*@OwnPar*/ /*@NoRep*/ RecoveredMethod)this;
}
/*
...
/*	
	...
	if ((localDeclaration.modifiers & ~AccFinal) != 0 // local var can only be final 
		...
		if (this.parent == null){
			return (RecoveredMethod)this; // ignore
		} else {
...
public RecoveredElement add(TypeDeclaration typeDeclaration, int bracketBalanceValue) {
	...
	RecoveredType element = new RecoveredType(typeDeclaration, (/*@OwnPar*/ /*@NoRep*/ RecoveredMethod)this, bracketBalanceValue);
