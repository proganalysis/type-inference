...
public class UnaryExpression extends OperatorExpression {
	...
	public TypeBinding resolveType(BlockScope scope) {
		...
		if (expressionTypeID > 15) {
			this.constant = Constant.NotAConstant;
			scope.problemReporter().invalidOperator((/*@OwnPar*/ /*@NoRep*/ UnaryExpression)this, expressionType);
			return null;
		}
	...
	public void traverse(
		...
		if (visitor.visit((/*@OwnPar*/ /*@NoRep*/ UnaryExpression)this, blockScope)) {
			this.expression.traverse(visitor, blockScope);
		}
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ UnaryExpression)this, blockScope);
	}
}
