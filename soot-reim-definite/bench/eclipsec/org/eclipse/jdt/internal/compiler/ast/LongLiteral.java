...
public TypeBinding resolveType(BlockScope scope) {
	...
	if (constant == FORMAT_ERROR) {
		...
		scope.problemReporter().constantOutOfFormat((/*@OwnPar*/ /*@NoRep*/ LongLiteral)this);
...
public void traverse(ASTVisitor visitor, BlockScope scope) {
	visitor.visit((/*@OwnPar*/ /*@NoRep*/ LongLiteral)this, scope);
	visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ LongLiteral)this, scope);
}
}
