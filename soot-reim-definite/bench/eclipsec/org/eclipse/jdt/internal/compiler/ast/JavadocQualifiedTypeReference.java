...
public class JavadocQualifiedTypeReference extends QualifiedTypeReference {
	...
	protected void reportInvalidType(Scope scope) {
		scope.problemReporter().javadocInvalidType((/*@OwnPar*/ /*@NoRep*/ JavadocQualifiedTypeReference)this, resolvedType, scope.getDeclarationModifiers());
	}
	protected void reportDeprecatedType(Scope scope) {
		scope.problemReporter().javadocDeprecatedType(resolvedType, (/*@OwnPar*/ /*@NoRep*/ JavadocQualifiedTypeReference)this, scope.getDeclarationModifiers());
	}
	...
	public void traverse(ASTVisitor visitor, BlockScope scope) {
		visitor.visit((/*@OwnPar*/ /*@NoRep*/ JavadocQualifiedTypeReference)this, scope);
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ JavadocQualifiedTypeReference)this, scope);
	}
