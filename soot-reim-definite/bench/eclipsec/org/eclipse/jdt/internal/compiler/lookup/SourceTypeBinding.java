...
private void addDefaultAbstractMethod(MethodBinding abstractMethod) {
	MethodBinding defaultAbstract = new MethodBinding(
		...
		(/*@OwnPar*/ /*@NoRep*/ SourceTypeBinding)this);
			...
			for (int i = 0, max = typeDecl.fields.length; i < max; i++) {
				...
				if (fieldDecl.binding == existingField) {
					if (this.scope.compilerOptions().complianceLevel >= ClassFileConstants.JDK1_5) {
						...
						scope.problemReporter().duplicateFieldInType((/*@OwnPar*/ /*@NoRep*/ SourceTypeBinding)this, fieldDecl);
					}
					break;
				}
			}
...
public FieldBinding addSyntheticFieldForClassLiteral(TypeBinding targetType, BlockScope blockScope) {
	...
	if ((existingField = this.getField(synthField.name, true /*resolve*/)) != null) {
		...
		for (int i = 0, max = typeDecl.fields.length; i < max; i++) {
			FieldDeclaration fieldDecl = typeDecl.fields[i];
			if (fieldDecl.binding == existingField) {
				blockScope.problemReporter().duplicateFieldInType((/*@OwnPar*/ /*@NoRep*/ SourceTypeBinding)this, fieldDecl);
				break;
			}
		}
	}		
...
public FieldBinding addSyntheticFieldForEnumValues() {
	...
	if (synthField == null) {
		synthField = new SyntheticFieldBinding(
			...
			scope.createArrayType((/*@OwnPar*/ /*@NoRep*/ SourceTypeBinding)this,1),
...
public SyntheticMethodBinding addSyntheticMethod(FieldBinding targetField, boolean isReadAccess) {
	...
	if (accessors == null) {
		accessMethod = new SyntheticMethodBinding(targetField, isReadAccess, (/*@OwnPar*/ /*@NoRep*/ SourceTypeBinding)this);
...
public SyntheticMethodBinding addSyntheticEnumMethod(char[] selector) {
	...
	if (accessors == null) {
		accessMethod = new SyntheticMethodBinding((/*@OwnPar*/ /*@NoRep*/ SourceTypeBinding)this, selector);
...
public SyntheticMethodBinding addSyntheticMethodForSwitchEnum(TypeBinding enumBinding) {
	...
	/*@OwnOwn*/ org.eclipse.jdt.internal.compiler.lookup.SyntheticMethodBinding /*@NoRep*/ [] accessors = (SyntheticMethodBinding[]) synthetics[METHOD_EMUL].get(key);
	...
	if (accessors == null) {
		...
		accessMethod = new SyntheticMethodBinding(fieldBinding, (/*@OwnPar*/ /*@NoRep*/ SourceTypeBinding)this, enumBinding, selector);
...
public SyntheticMethodBinding addSyntheticMethod(MethodBinding targetMethod, boolean isSuperAccess) {
	...
	SyntheticMethodBinding accessMethod = null;
	/*@OwnOwn*/ org.eclipse.jdt.internal.compiler.lookup.SyntheticMethodBinding /*@NoRep*/ [] accessors = (SyntheticMethodBinding[]) synthetics[METHOD_EMUL].get(targetMethod);
	if (accessors == null) {
		accessMethod = new SyntheticMethodBinding(targetMethod, isSuperAccess, (/*@OwnPar*/ /*@NoRep*/ SourceTypeBinding)this);
...
public SyntheticMethodBinding addSyntheticBridgeMethod(MethodBinding inheritedMethodToBridge, MethodBinding targetMethod) {
	...
	if (synthetics[METHOD_EMUL] == null) {
		...
		/*@RepNorep*/ Iterator synthMethods = synthetics[METHOD_EMUL].keySet().iterator();
	...
	SyntheticMethodBinding accessMethod = null;
	/*@OwnOwn*/ org.eclipse.jdt.internal.compiler.lookup.SyntheticMethodBinding /*@NoRep*/ [] accessors = (SyntheticMethodBinding[]) synthetics[METHOD_EMUL].get(inheritedMethodToBridge);
	if (accessors == null) {
		accessMethod = new SyntheticMethodBinding(inheritedMethodToBridge, targetMethod, (/*@OwnPar*/ /*@NoRep*/ SourceTypeBinding)this);
...
public long getAnnotationTagBits() {
	if ((this.tagBits & AnnotationResolved) == 0) {
		...
		try {
			...
			ASTNode.resolveAnnotations(typeDecl.staticInitializerScope, typeDecl.annotations, (/*@OwnPar*/ /*@NoRep*/ SourceTypeBinding)this);
		} finally {
...
public MethodBinding[] getMethods(char[] selector) {
	...
	/*@RepRep*/ java.util.ArrayList matchingMethods = null;
...
public FieldBinding getSyntheticField(ReferenceBinding targetEnclosingType, boolean onlyExactMatch) {
	...
	if (!onlyExactMatch){
		/*@RepNorep*/ Iterator accessFields = ((/*@RepNorep*/ java.util.Collection) synthetics[FIELD_EMUL].values()).iterator();
...
public boolean isEquivalentTo(TypeBinding otherType) {
	...
	switch(otherType.kind()) {
		...
		case Binding.WILDCARD_TYPE :
			return ((WildcardBinding) otherType).boundCheck((/*@OwnPar*/ /*@NoRep*/ SourceTypeBinding)this);
		...
		case Binding.RAW_TYPE :
	        return otherType.erasure() == (/*@OwnPar*/ /*@NoRep*/ SourceTypeBinding)this;
	}
	return false;
}
...
public FieldBinding getUpdatedFieldBinding(FieldBinding targetField, ReferenceBinding newDeclaringClass) {
	...
	/*@NoRep*/ Hashtable</*@RepRep*/ Object, /*@RepRep*/ Object> fieldMap = (Hashtable) this.synthetics[RECEIVER_TYPE_EMUL].get(targetField);
	if (fieldMap == null) {
...
public MethodBinding getUpdatedMethodBinding(MethodBinding targetMethod, ReferenceBinding newDeclaringClass) {
	...
	/*@NoRep*/ Hashtable</*@RepRep*/ Object, /*@RepRep*/ Object> methodMap = (Hashtable) synthetics[RECEIVER_TYPE_EMUL].get(targetMethod);
	if (methodMap == null) {
			...
			if (method != null) {
				...
				nextMethod : for (int j = length - 1; j > i; j--) {
					...
					if (methodDecl == null) {
						...
						if (methodDecl != null && methodDecl.binding != null) { // ensure its a valid user defined method
							if (isEnumSpecialMethod)
								scope.problemReporter().duplicateEnumSpecialMethod((/*@OwnPar*/ /*@NoRep*/ SourceTypeBinding)this, methodDecl);
							else
								scope.problemReporter().duplicateMethodInType((/*@OwnPar*/ /*@NoRep*/ SourceTypeBinding)this, methodDecl);
					...
					if (method2Decl != null && method2Decl.binding != null) { // ensure its a valid user defined method
						if (isEnumSpecialMethod)
							scope.problemReporter().duplicateEnumSpecialMethod((/*@OwnPar*/ /*@NoRep*/ SourceTypeBinding)this, method2Decl);
						else
							scope.problemReporter().duplicateMethodInType((/*@OwnPar*/ /*@NoRep*/ SourceTypeBinding)this, method2Decl);
			...
			try {
				...
				TypeBinding fieldType = 
					fieldDecl.getKind() == AbstractVariableDeclaration.ENUM_CONSTANT
						? initializationScope.environment().convertToRawType((/*@OwnPar*/ /*@NoRep*/ SourceTypeBinding)this) // enum constant is implicitly of declaring enum type
	...
	if (exceptionTypes != null) {
		...
		for (int i = 0; i < size; i++) {
			...
			if (throwable != resolvedExceptionType && !throwable.isSuperclassOf(resolvedExceptionType)) {
				methodDecl.scope.problemReporter().cannotThrowType((/*@OwnPar*/ /*@NoRep*/ SourceTypeBinding)this, methodDecl, exceptionTypes[i], resolvedExceptionType);
				continue;
			}
	...
	if (arguments != null) {
		...
		for (int i = 0; i < size; i++) {
			...
			if (parameterType == null) {
				...
				methodDecl.scope.problemReporter().argumentTypeCannotBeVoid((/*@OwnPar*/ /*@NoRep*/ SourceTypeBinding)this, methodDecl, arg);
				foundArgProblem = true;
			} else if (parameterType.isArrayType() && ((ArrayBinding) parameterType).leafComponentType == VoidBinding) {
				methodDecl.scope.problemReporter().argumentTypeCannotBeVoidArray((/*@OwnPar*/ /*@NoRep*/ SourceTypeBinding)this, methodDecl, arg);
				foundArgProblem = true;
			} else {
	...
	if (!method.isConstructor()) {
		...
		if (returnType == null) {
			...
			if (methodType == null) {
				...
				methodDecl.scope.problemReporter().returnTypeCannotBeVoidArray((/*@OwnPar*/ /*@NoRep*/ SourceTypeBinding)this, (MethodDeclaration) methodDecl);
				foundReturnTypeProblem = true;
			} else {
...
public SyntheticMethodBinding[] syntheticMethods() {
	...
	while (fieldsOrMethods.hasNext()) {
		...
		if (fieldOrMethod instanceof MethodBinding) {
			...
			/*@OwnOwn*/ org.eclipse.jdt.internal.compiler.lookup.SyntheticMethodBinding /*@NoRep*/ [] methodAccessors = (SyntheticMethodBinding[]) synthetics[METHOD_EMUL].get(fieldOrMethod);
			...
			/*@OwnOwn*/ org.eclipse.jdt.internal.compiler.lookup.SyntheticMethodBinding /*@NoRep*/ [] fieldAccessors = (SyntheticMethodBinding[]) synthetics[METHOD_EMUL].get(fieldOrMethod);
			int numberOfAccessors = 0;
	...
	int length;
	/*@NoRep*/ org.eclipse.jdt.internal.compiler.lookup.SyntheticMethodBinding /*@OwnOwn*/ [] sortedBindings = new SyntheticMethodBinding[length = bindings.length];
	for (int i = 0; i < length; i++){
...
public FieldBinding[] syntheticFields() {
	...
	/*@NoRep*/ org.eclipse.jdt.internal.compiler.lookup.FieldBinding /*@OwnOwn*/ [] bindings = new FieldBinding[totalSize];

	// add innerclass synthetics
	if (synthetics[FIELD_EMUL] != null){
		/*@RepNorep*/ Iterator elements = ((/*@RepNorep*/ java.util.Collection) synthetics[FIELD_EMUL].values()).iterator();
	...
	if (synthetics[CLASS_LITERAL_EMUL] != null){
		/*@RepNorep*/ Iterator elements = ((/*@RepNorep*/ java.util.Collection) synthetics[CLASS_LITERAL_EMUL].values()).iterator();
...
void verifyMethods(MethodVerifier verifier) {
	verifier.verify((/*@OwnPar*/ /*@NoRep*/ SourceTypeBinding)this);
