...
public class TypeParameter extends AbstractVariableDeclaration {
	...
	public /*@NoRep*/ org.eclipse.jdt.internal.compiler.ast.TypeReference [] bounds;
	...
	public void traverse(ASTVisitor visitor, BlockScope scope) {
		if (visitor.visit((/*@OwnPar*/ /*@NoRep*/ TypeParameter)this, scope)) {
			if (type != null) {
		...
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ TypeParameter)this, scope);
	}
