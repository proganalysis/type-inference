...
public class JavadocAllocationExpression extends AllocationExpression {
	...
	private TypeBinding internalResolveType(Scope scope) {
		...
		this.binding = scope.getConstructor(allocationType, argumentTypes, (/*@OwnPar*/ /*@NoRep*/ JavadocAllocationExpression)this);
		if (!this.binding.isValidBinding()) {
			...
			while (!contructorBinding.isValidBinding() && (enclosingTypeBinding.isMemberType() || enclosingTypeBinding.isLocalType())) {
				...
				contructorBinding = scope.getConstructor(enclosingTypeBinding, argumentTypes, (/*@OwnPar*/ /*@NoRep*/ JavadocAllocationExpression)this);
			}
		...
		if (!this.binding.isValidBinding()) {
			...
			MethodBinding methodBinding = scope.getMethod(this.resolvedType, this.resolvedType.sourceName(), argumentTypes, (/*@OwnPar*/ /*@NoRep*/ JavadocAllocationExpression)this);
			if (methodBinding.isValidBinding()) {
				...
				scope.problemReporter().javadocInvalidConstructor((/*@OwnPar*/ /*@NoRep*/ JavadocAllocationExpression)this, this.binding, scope.getDeclarationModifiers());
			}
			...
			if (!(binding.parameters.length == length && argumentTypes[length-1].isArrayType())) {
				...
				scope.problemReporter().javadocInvalidConstructor((/*@OwnPar*/ /*@NoRep*/ JavadocAllocationExpression)this, problem, scope.getDeclarationModifiers());
			}
		} else if (hasTypeVarArgs) {
			MethodBinding problem = new ProblemMethodBinding(this.binding, this.binding.selector, argumentTypes, ProblemReasons.NotFound);
			scope.problemReporter().javadocInvalidConstructor((/*@OwnPar*/ /*@NoRep*/ JavadocAllocationExpression)this, problem, scope.getDeclarationModifiers());
		...
		if (isMethodUseDeprecated(this.binding, scope, true)) {
			scope.problemReporter().javadocDeprecatedMethod(this.binding, (/*@OwnPar*/ /*@NoRep*/ JavadocAllocationExpression)this, scope.getDeclarationModifiers());
		}
