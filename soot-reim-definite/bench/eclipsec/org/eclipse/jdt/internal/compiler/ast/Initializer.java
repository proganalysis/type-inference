...
public class Initializer extends FieldDeclaration {
	...
	public void parseStatements(
		/*@OwnPar*/ Parser parser,
		TypeDeclaration typeDeclaration,
		CompilationUnitDeclaration unit) {

		//fill up the method body with statement
		parser.parse((/*@OwnPar*/ /*@NoRep*/ Initializer)this, typeDeclaration, unit);
	}
	...
	public void traverse(ASTVisitor visitor, MethodScope scope) {
		...
		if (visitor.visit((/*@OwnPar*/ /*@NoRep*/ Initializer)this, scope)) {
			block.traverse(visitor, scope);
		}
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ Initializer)this, scope);
	}
}
