...
public abstract class Expression extends Statement {
	...
	public void checkNullComparison(BlockScope scope, /*@NoRep*/ FlowContext flowContext, FlowInfo flowInfo, FlowInfo initsWhenTrue, /*@OwnOwn*/ FlowInfo initsWhenFalse) {
	...
	public FlowInfo checkNullStatus(BlockScope scope, FlowContext flowContext, FlowInfo flowInfo, int nullStatus) {
		...
		if (local != null) {
			switch(nullStatus) {
				case FlowInfo.NULL :
					flowContext.recordUsingNullReference(scope, local, (/*@OwnPar*/ /*@NoRep*/ Expression)this, FlowInfo.NULL, flowInfo);
					flowInfo.markAsDefinitelyNull(local); // from thereon it is set
					break;
				case FlowInfo.NON_NULL :
					flowContext.recordUsingNullReference(scope, local, (/*@OwnPar*/ /*@NoRep*/ Expression)this, FlowInfo.NON_NULL, flowInfo);
	...
	public void computeConversion(Scope scope, TypeBinding runtimeType, TypeBinding compileTimeType) {
		...
		if (runtimeType != NullBinding && runtimeType.isBaseType()) {
			if (!compileTimeType.isBaseType()) {
				...
				scope.problemReporter().autoboxing((/*@OwnPar*/ /*@NoRep*/ Expression)this, compileTimeType, runtimeType);
			...
			if (compileTimeType != NullBinding && compileTimeType.isBaseType()) {
				...
				scope.problemReporter().autoboxing((/*@OwnPar*/ /*@NoRep*/ Expression)this, compileTimeType, scope.environment().computeBoxingType(boxedType));
				return;
			}
		}
...
//				}		
	...
	private MethodBinding[] getAllInheritedMethods(ReferenceBinding binding) {
		/*@RepRep*/ ArrayList collector = new ArrayList();
	...
	public TypeBinding resolveTypeExpecting(
		...
		if (!expressionType.isCompatibleWith(expectedType)) {
			if (scope.isBoxingCompatibleWith(expressionType, expectedType)) {
				...
				scope.problemReporter().typeMismatchError(expressionType, expectedType, (/*@OwnPar*/ /*@NoRep*/ Expression)this);
				return null;
			}
		}
	...
	public Expression toTypeReference() {
		...
		return (/*@OwnPar*/ /*@NoRep*/ Expression)this;
	}
