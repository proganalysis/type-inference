...
public Constant getConstant() {
	if (constant == null) {
		// read constant
		((/*@checkers.inference.reim.quals.Mutable*/ FieldInfo) this).readConstantAttribute();
	}
	return constant;
}
...
public int getModifiers() {
	if (this.accessFlags == -1) {
		...
		((/*@checkers.inference.reim.quals.Mutable*/ FieldInfo) this).accessFlags = u2At(0);
		((/*@checkers.inference.reim.quals.Mutable*/ FieldInfo) this).readModifierRelatedAttributes();
	}
...
public char[] getName() {
	if (name == null) {
		...
		((/*@checkers.inference.reim.quals.Mutable*/ FieldInfo) this).name = utf8At(utf8Offset + 3, u2At(utf8Offset + 1));
	}
	return name;
}
...
public char[] getTypeName() {
	if (descriptor == null) {
		...
		((/*@checkers.inference.reim.quals.Mutable*/ FieldInfo) this).descriptor = utf8At(utf8Offset + 3, u2At(utf8Offset + 1));
	}
	return descriptor;
}
/**
...
public String toString() {
	/*@NoRep*/ StringBuffer buffer = new StringBuffer(this.getClass().getName());
