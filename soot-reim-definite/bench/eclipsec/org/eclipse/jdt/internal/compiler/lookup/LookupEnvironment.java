...
public class LookupEnvironment implements BaseTypes, ProblemReasons, TypeConstants {
	 ...
	 */
	private /*@OwnPar*/ Map accessRestrictions;
	ImportBinding[] defaultImports;

	PackageBinding defaultPackage;
	/*@RepRep*/ HashtableOfPackage knownPackages;
	private int lastCompletedUnitIndex = -1;
	private int lastUnitIndex = -1;

	public INameEnvironment nameEnvironment;
	public CompilerOptions globalOptions;
	public /*@NoRep*/ ProblemReporter problemReporter;
...
public LookupEnvironment(/*@NoRep*/ ITypeRequestor typeRequestor, CompilerOptions globalOptions, ProblemReporter problemReporter, INameEnvironment nameEnvironment) {
	this.typeRequestor = typeRequestor;
	this.globalOptions = globalOptions;
	this.problemReporter = problemReporter;
	this.defaultPackage = new PackageBinding((/*@OwnPar*/ /*@NoRep*/ LookupEnvironment)this); // assume the default package always exists
...
public void buildTypeBindings(CompilationUnitDeclaration unit, AccessRestriction accessRestriction) {
	/*@RepRep*/ CompilationUnitScope scope = new CompilationUnitScope(unit, (/*@OwnPar*/ /*@NoRep*/ LookupEnvironment)this);
...
private PackageBinding computePackageFrom(char[][] constantPoolName) {
	...
	if (packageBinding == null || packageBinding == TheNotFoundPackage) {
		packageBinding = new PackageBinding(constantPoolName[0], (/*@OwnPar*/ /*@NoRep*/ LookupEnvironment)this);
	...
	for (int i = 1, length = constantPoolName.length - 1; i < length; i++) {
		...
		if ((packageBinding = parent.getPackage0(constantPoolName[i])) == null || packageBinding == TheNotFoundPackage) {
			packageBinding = new PackageBinding(CharOperation.subarray(constantPoolName, 0, i + 1), parent, (/*@OwnPar*/ /*@NoRep*/ LookupEnvironment)this);
...
public ArrayBinding createArrayType(TypeBinding leafComponentType, int dimensionCount) {
	...
	while (++index < length) {
		...
		if (currentBinding == null) // no matching array, but space left
			return arrayBindings[index] = new ArrayBinding(leafComponentType, dimensionCount, (/*@OwnPar*/ /*@NoRep*/ LookupEnvironment)this);
	...
	return arrayBindings[length] = new ArrayBinding(leafComponentType, dimensionCount, (/*@OwnPar*/ /*@NoRep*/ LookupEnvironment)this);
}
...
public BinaryTypeBinding createBinaryTypeFrom(IBinaryType binaryType, PackageBinding packageBinding, boolean needFieldsAndMethods, AccessRestriction accessRestriction) {
	BinaryTypeBinding binaryBinding = new BinaryTypeBinding(packageBinding, binaryType, (/*@OwnPar*/ /*@NoRep*/ LookupEnvironment)this);
	...
	if (cachedType != null) { // update reference to unresolved binding after having read classfile (knows whether generic for raw conversion)
		if (cachedType instanceof UnresolvedReferenceBinding) {
			((UnresolvedReferenceBinding) cachedType).setResolvedType(binaryBinding, (/*@OwnPar*/ /*@NoRep*/ LookupEnvironment)this);
		} else {
...
PackageBinding createPackage(char[][] compoundName) {
	...
	if (packageBinding == null || packageBinding == TheNotFoundPackage) {
		packageBinding = new PackageBinding(compoundName[0], (/*@OwnPar*/ /*@NoRep*/ LookupEnvironment)this);
	...
	for (int i = 1, length = compoundName.length; i < length; i++) {
		...
		if ((packageBinding = parent.getPackage0(compoundName[i])) == null || packageBinding == TheNotFoundPackage) {
			...
			packageBinding = new PackageBinding(CharOperation.subarray(compoundName, 0, i + 1), parent, (/*@OwnPar*/ /*@NoRep*/ LookupEnvironment)this);
			parent.addPackage(packageBinding);
		}
	}
	return packageBinding;
...
public ParameterizedTypeBinding createParameterizedType(ReferenceBinding genericType, TypeBinding[] typeArguments, ReferenceBinding enclosingType) {
	...
	// add new binding
	ParameterizedTypeBinding parameterizedType = new ParameterizedTypeBinding(genericType,typeArguments, enclosingType, (/*@OwnPar*/ /*@NoRep*/ LookupEnvironment)this);
...
public RawTypeBinding createRawType(ReferenceBinding genericType, ReferenceBinding enclosingType) {
	...
	// add new binding
	RawTypeBinding rawType = new RawTypeBinding(genericType, enclosingType, (/*@OwnPar*/ /*@NoRep*/ LookupEnvironment)this);
...
public WildcardBinding createWildcard(ReferenceBinding genericType, int rank, TypeBinding bound, TypeBinding[] otherBounds, int boundKind) {
	...
	// add new binding
	WildcardBinding wildcard = new WildcardBinding(genericType, rank, bound, otherBounds, boundKind, (/*@OwnPar*/ /*@NoRep*/ LookupEnvironment)this);
...
PackageBinding getTopLevelPackage(char[] name) {
	...
	if (nameEnvironment.isPackage(null, name)) {
		knownPackages.put(name, packageBinding = new PackageBinding(name, (/*@OwnPar*/ /*@NoRep*/ LookupEnvironment)this));
		return packageBinding;
	}
...
public ReferenceBinding getType(char[][] compoundName) {
	...
	if (referenceBinding == null || referenceBinding == TheNotFoundType)
		return null;
	referenceBinding = BinaryTypeBinding.resolveType(referenceBinding, (/*@OwnPar*/ /*@NoRep*/ LookupEnvironment)this, false); // no raw conversion for now
...
private TypeBinding[] getTypeArgumentsFromSignature(SignatureWrapper wrapper, TypeVariableBinding[] staticVariables, ReferenceBinding enclosingType, ReferenceBinding genericType) {
	/*@RepRep*/ java.util.ArrayList args = new java.util.ArrayList(2);
	int rank = 0;
	do {
...
TypeBinding getTypeFromTypeSignature(SignatureWrapper wrapper, TypeVariableBinding[] staticVariables, ReferenceBinding enclosingType) {
	...
	while (wrapper.signature[wrapper.start] == '.') {
		...
		BinaryTypeBinding.resolveType(parameterizedType, (/*@OwnPar*/ /*@NoRep*/ LookupEnvironment)this, false);
...
public MethodVerifier methodVerifier() {
	if (verifier == null)
		verifier = this.globalOptions.complianceLevel < ClassFileConstants.JDK1_5
			? new MethodVerifier((/*@OwnPar*/ /*@NoRep*/ LookupEnvironment)this)
			: new MethodVerifier15((/*@OwnPar*/ /*@NoRep*/ LookupEnvironment)this); // check for covariance even if sourceLevel is < 1.5
	return verifier;
}
public void reset() {
	this.defaultPackage = new PackageBinding((/*@OwnPar*/ /*@NoRep*/ LookupEnvironment)this); // assume the default package always exists
