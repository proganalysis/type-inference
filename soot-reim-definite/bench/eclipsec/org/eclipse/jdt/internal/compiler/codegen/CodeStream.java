...
public void generateClassLiteralAccessForType(TypeBinding accessedType, FieldBinding syntheticFieldBinding) {
	Label endLabel;
	/*@RepRep*/ ExceptionLabel anyExceptionHandler;
	int saveStackSize;
	...
	if (this.targetLevel >= ClassFileConstants.JDK1_5) {
		...
		endLabel = new Label((/*@OwnPar*/ /*@NoRep*/ CodeStream)this);
		...
		anyExceptionHandler = new ExceptionLabel((/*@OwnPar*/ /*@NoRep*/ CodeStream)this, BaseTypes.NullBinding /* represents ClassNotFoundException*/);
...
public void generateStringConcatenationAppend(BlockScope blockScope, Expression oper1, Expression oper2) {
	...
	if (oper1 == null) {
		...
		pc = position;
		oper1.generateOptimizedStringConcatenationCreation(blockScope, (/*@OwnPar*/ /*@NoRep*/ CodeStream)this, oper1.implicitConversion & COMPILE_TYPE_MASK);
		this.recordPositionsFrom(pc, oper1.sourceStart);
	}
	pc = position;
	oper2.generateOptimizedStringConcatenation(blockScope, (/*@OwnPar*/ /*@NoRep*/ CodeStream)this, oper2.implicitConversion & COMPILE_TYPE_MASK);
	...
	if ((syntheticArgumentTypes = targetType.syntheticEnclosingInstanceTypes()) != null) {
		...
		for (int i = 0, max = syntheticArgumentTypes.length; i < max; i++) {
			...
			if (hasExtraEnclosingInstance && syntheticArgType == targetEnclosingType) {
				...
				enclosingInstance.generateCode(currentScope, (/*@OwnPar*/ /*@NoRep*/ CodeStream)this, true);
				if (complyTo14){
					dup();
...
public void generateSyntheticBodyForEnumValueOf(SyntheticMethodBinding methodBinding) {
	...
	FieldBinding enumValuesSyntheticfield = scope.referenceContext.enumValuesSyntheticfield;
	initializeMaxLocals(methodBinding);
	Label loopCond = new Label((/*@OwnPar*/ /*@NoRep*/ CodeStream)this);
	Label loopStart = new Label((/*@OwnPar*/ /*@NoRep*/ CodeStream)this);
	Label wrongConstant = new Label((/*@OwnPar*/ /*@NoRep*/ CodeStream)this);
...
public void generateSyntheticBodyForSwitchTable(SyntheticMethodBinding methodBinding) {
	ClassScope scope = ((SourceTypeBinding)methodBinding.declaringClass).scope;
	initializeMaxLocals(methodBinding);
	final Label nullLabel = new Label((/*@OwnPar*/ /*@NoRep*/ CodeStream)this);
	...
	if (fields != null) {
		for (int i = 0, max = fields.length; i < max; i++) {
			...
			if ((fieldBinding.getAccessFlags() & ClassFileConstants.AccEnum) != 0) {
				final /*@OwnOwn*/ Label endLabel = new Label((/*@OwnPar*/ /*@NoRep*/ CodeStream)this);
				final /*@RepRep*/ ExceptionLabel anyExceptionHandler = new ExceptionLabel((/*@OwnPar*/ /*@NoRep*/ CodeStream)this, BaseTypes.LongBinding /* represents NoSuchFieldError*/);
				this.aload_0();
...
final public void lookupswitch(CaseLabel defaultLabel, int[] keys, int[] sortedIndexes, /*@NoRep*/ org.eclipse.jdt.internal.compiler.codegen.CaseLabel /*@OwnOwn*/ [] casesLabel) {
...
final public void tableswitch(CaseLabel defaultLabel, int low, int high, int[] keys, int[] sortedIndexes, /*@NoRep*/ org.eclipse.jdt.internal.compiler.codegen.CaseLabel /*@OwnOwn*/ [] casesLabel) {
...
public void generateWideRevertedConditionalBranch(byte revertedOpcode, Label wideTarget) {
		/*@RepRep*/ Label intermediate = new Label((/*@OwnPar*/ /*@NoRep*/ CodeStream)this);
		if (classFileOffset >= bCodeStream.length) {
			resizeByteArray();
		}
		position++;
