...
public class LocalDeclaration extends AbstractVariableDeclaration {
	...
	public void resolve(BlockScope scope) {
		...
		if (variableType != null) {
			if (variableType == VoidBinding) {
				scope.problemReporter().variableTypeCannotBeVoid((/*@OwnPar*/ /*@NoRep*/ LocalDeclaration)this);
				return;
			}
			if (variableType.isArrayType() && ((ArrayBinding) variableType).leafComponentType == VoidBinding) {
				scope.problemReporter().variableTypeCannotBeVoidArray((/*@OwnPar*/ /*@NoRep*/ LocalDeclaration)this);
				return;
			}
		}
		
		Binding existingVariable = scope.getBinding(name, Binding.VARIABLE, (/*@OwnPar*/ /*@NoRep*/ LocalDeclaration)this, false /*do not resolve hidden field*/);
		boolean shouldInsertInScope = true;
		if (existingVariable != null && existingVariable.isValidBinding()){
			if (existingVariable instanceof LocalVariableBinding && this.hiddenVariableDepth == 0) {
				shouldInsertInScope = false;
				scope.problemReporter().redefineLocal((/*@OwnPar*/ /*@NoRep*/ LocalDeclaration)this);
			} else {
				scope.problemReporter().localVariableHiding((/*@OwnPar*/ /*@NoRep*/ LocalDeclaration)this, existingVariable, false);
			}
		}
		...
		if (shouldInsertInScope) {
			...
			this.binding = new LocalVariableBinding((/*@OwnPar*/ /*@NoRep*/ LocalDeclaration)this, variableType, modifiers, false);
	...
	public void traverse(ASTVisitor visitor, BlockScope scope) {
		...
		if (visitor.visit((/*@OwnPar*/ /*@NoRep*/ LocalDeclaration)this, scope)) {
			type.traverse(visitor, scope);
			if (initialization != null)
				initialization.traverse(visitor, scope);
		}
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ LocalDeclaration)this, scope);
	}
}
