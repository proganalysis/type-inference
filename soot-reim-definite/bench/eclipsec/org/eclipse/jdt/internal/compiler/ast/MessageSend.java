...
public class MessageSend extends Expression implements InvocationSite {
	...
	public /*@NoRep*/ TypeReference[] typeArguments;
...
public FlowInfo analyseCode(BlockScope currentScope, FlowContext flowContext, FlowInfo flowInfo) {
	...
	if ((thrownExceptions = binding.thrownExceptions) != NoExceptions) {
		...
		flowContext.checkExceptionHandlers(thrownExceptions, (/*@OwnPar*/ /*@NoRep*/ MessageSend)this, flowInfo, currentScope);
	}
...
public void generateCode(BlockScope currentScope, CodeStream codeStream, boolean valueRequired) {
	...
	if (!isStatic && ((bits & DepthMASK) != 0) && receiver.isImplicitThis()){
		...
		codeStream.generateOuterAccess(path, (/*@OwnPar*/ /*@NoRep*/ MessageSend)this, targetType, currentScope);
	} else {
...
public void manageSyntheticAccessIfNecessary(BlockScope currentScope, FlowInfo flowInfo){
	...
	if (this.binding.isPrivate()){
		...
		if (currentScope.enclosingSourceType() != this.codegenBinding.declaringClass){
			...
			currentScope.problemReporter().needToEmulateMethodAccess(this.codegenBinding, (/*@OwnPar*/ /*@NoRep*/ MessageSend)this);
			return;
		}
...
public TypeBinding resolveType(BlockScope scope) {
	...
	if (arguments != null) {
		...
		if (argHasError) {
			if (actualReceiverType instanceof ReferenceBinding) {
				...
				this.binding = scope.findMethod((ReferenceBinding) actualReceiverType, selector, pseudoArgs, (/*@OwnPar*/ /*@NoRep*/ MessageSend)this);
			}
			return null;
		}
	}
	...
	if (this.actualReceiverType.isBaseType()) {
		scope.problemReporter().errorNoMethodFor((/*@OwnPar*/ /*@NoRep*/ MessageSend)this, this.actualReceiverType, argumentTypes);
		return null;
	}
	this.binding = 
		receiver.isImplicitThis()
			? scope.getImplicitMethod(selector, argumentTypes, (/*@OwnPar*/ /*@NoRep*/ MessageSend)this)
			: scope.getMethod(this.actualReceiverType, selector, argumentTypes, (/*@OwnPar*/ /*@NoRep*/ MessageSend)this); 
	if (!binding.isValidBinding()) {
		...
		scope.problemReporter().invalidMethod((/*@OwnPar*/ /*@NoRep*/ MessageSend)this, binding);
	...
	if (!binding.isStatic()) {
		...
		if (receiverIsType) {
			scope.problemReporter().mustUseAStaticMethod((/*@OwnPar*/ /*@NoRep*/ MessageSend)this, binding);
		...
		if (!(receiver.isImplicitThis() || receiver.isSuper() || receiverIsType)) {
			scope.problemReporter().nonStaticAccessToStaticMethod((/*@OwnPar*/ /*@NoRep*/ MessageSend)this, binding);
		}
		if (!receiver.isImplicitThis() && binding.declaringClass != actualReceiverType) {
			scope.problemReporter().indirectAccessToStaticMethod((/*@OwnPar*/ /*@NoRep*/ MessageSend)this, binding);
		}		
	}
	checkInvocationArguments(scope, this.receiver, actualReceiverType, binding, this.arguments, argumentTypes, argsContainCast, (/*@OwnPar*/ /*@NoRep*/ MessageSend)this);

	//-------message send that are known to fail at compile time-----------
	if (binding.isAbstract()) {
		if (receiver.isSuper()) {
			scope.problemReporter().cannotDireclyInvokeAbstractMethod((/*@OwnPar*/ /*@NoRep*/ MessageSend)this, binding);
		}
		// abstract private methods cannot occur nor abstract static............
	}
	if (isMethodUseDeprecated(binding, scope, true))
		scope.problemReporter().deprecatedMethod(binding, (/*@OwnPar*/ /*@NoRep*/ MessageSend)this);
...
public void traverse(ASTVisitor visitor, BlockScope blockScope) {
	if (visitor.visit((/*@OwnPar*/ /*@NoRep*/ MessageSend)this, blockScope)) {
	...
	visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ MessageSend)this, blockScope);
}
}
