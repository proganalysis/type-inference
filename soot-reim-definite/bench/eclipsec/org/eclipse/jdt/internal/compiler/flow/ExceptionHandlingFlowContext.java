...
public class ExceptionHandlingFlowContext extends FlowContext {
	...
	int[] isReached;
	int[] isNeeded;
	/*@NoRep*/ org.eclipse.jdt.internal.compiler.flow.UnconditionalFlowInfo /*@RepRep*/ [] initsOnExceptions;
	/*@RepRep*/ ObjectCache indexes = new ObjectCache();
	boolean isMethodContext;

	public UnconditionalFlowInfo initsOnReturn;

	// for dealing with anonymous constructor thrown exceptions
	public /*@OwnOwn*/ ArrayList extendedExceptions;
