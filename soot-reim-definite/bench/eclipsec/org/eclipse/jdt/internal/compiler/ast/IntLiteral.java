...
public TypeBinding resolveType(BlockScope scope) {
	...
	if (constant == FORMAT_ERROR) {
		...
		scope.problemReporter().constantOutOfFormat((/*@OwnPar*/ /*@NoRep*/ IntLiteral)this);
...
public void traverse(ASTVisitor visitor, BlockScope scope) {
	visitor.visit((/*@OwnPar*/ /*@NoRep*/ IntLiteral)this, scope);
	visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ IntLiteral)this, scope);
}
}
