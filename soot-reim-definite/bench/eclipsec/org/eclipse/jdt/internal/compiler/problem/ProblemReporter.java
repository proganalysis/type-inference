...
public void illegalModifierForVariable(/*@OwnOwn*/ LocalDeclaration localDecl, boolean complainAsArgument) {
	String[] arguments = new String[] {new String(localDecl.name)};
	this.handle(
		complainAsArgument
...
public void incompatibleReturnType(MethodBinding currentMethod, MethodBinding inheritedMethod) {
	/*@RepRep*/ StringBuffer methodSignature = new StringBuffer();
	methodSignature
		.append(inheritedMethod.declaringClass.readableName())
		.append('.')
		.append(inheritedMethod.readableName());

	/*@RepRep*/ StringBuffer shortSignature = new StringBuffer();
	shortSignature
...
public void inheritedMethodReducesVisibility(SourceTypeBinding type, MethodBinding concreteMethod, MethodBinding[] abstractMethods) {
	/*@RepRep*/ StringBuffer concreteSignature = new StringBuffer();
	concreteSignature
...
public void inheritedMethodsHaveIncompatibleReturnTypes(SourceTypeBinding type, /*@NoRep*/ org.eclipse.jdt.internal.compiler.lookup.MethodBinding /*@OwnOwn*/ [] inheritedMethods, int length) {
	/*@RepRep*/ StringBuffer methodSignatures = new StringBuffer();
	/*@RepRep*/ StringBuffer shortSignatures = new StringBuffer();
...
public void invalidOperator(/*@OwnOwn*/ UnaryExpression expression, TypeBinding type) {
	this.handle(
		IProblem.InvalidOperator,
...
public void invalidUsageOfTypeArguments(TypeReference firstTypeReference, /*@OwnOwn*/ TypeReference lastTypeReference) {
	this.handle(
...
public void javadocInvalidConstructor(Statement statement, MethodBinding targetConstructor, int modifiers) {
	...
	int sourceEnd = statement.sourceEnd;
	if (statement instanceof AllocationExpression) {
		/*@OwnOwn*/ AllocationExpression allocation = (AllocationExpression)statement;
		if (allocation.enumConstant != null) {
			sourceStart = allocation.enumConstant.sourceStart;
			sourceEnd = allocation.enumConstant.sourceEnd;
		}
...
public void javadocInvalidMethod(MessageSend messageSend, MethodBinding method, int modifiers) {
	if (!javadocVisibility(this.options.reportInvalidJavadocTagsVisibility, modifiers)) return;
	// set problem id
	/*@OwnOwn*/ ProblemMethodBinding problemMethod = null;
...
public void packageCollidesWithType(/*@OwnOwn*/ CompilationUnitDeclaration compUnitDecl) {
...
public void packageIsNotExpectedPackage(/*@OwnOwn*/ CompilationUnitDeclaration compUnitDecl) {
	String[] arguments = new String[] {
...
public void staticInheritedMethodConflicts(SourceTypeBinding type, MethodBinding concreteMethod, /*@NoRep*/ org.eclipse.jdt.internal.compiler.lookup.MethodBinding /*@OwnOwn*/ [] abstractMethods) {
	this.handle(
...
public void typeCollidesWithPackage(/*@OwnOwn*/ CompilationUnitDeclaration compUnitDecl, TypeDeclaration typeDecl) {
	this.referenceContext = typeDecl; // report the problem against the type not the entire compilation unit
	String[] arguments = new String[] {new String(compUnitDecl.getFileName()), new String(typeDecl.name)};
	this.handle(
