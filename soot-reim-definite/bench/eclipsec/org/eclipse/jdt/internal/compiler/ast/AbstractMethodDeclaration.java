...
public abstract class AbstractMethodDeclaration
	...
	public /*@NoRep*/ org.eclipse.jdt.internal.compiler.ast.Argument [] arguments;
	public /*@NoRep*/ TypeReference[] thrownExceptions;
	...
	public void generateCode(ClassFile classFile) {
		...
		if ((!this.binding.isNative()) && (!this.binding.isAbstract())) {
			...
			codeStream.reset((/*@OwnPar*/ /*@NoRep*/ AbstractMethodDeclaration)this, classFile);
	...
	public void resolve(ClassScope upperScope) {
		...
		try {
			...
			if (this.binding != null
				...
				this.scope.problemReporter().missingDeprecatedAnnotationForMethod((/*@OwnPar*/ /*@NoRep*/ AbstractMethodDeclaration)this);
			}			
