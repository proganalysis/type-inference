...
public class BlockScope extends Scope {
	...
	public /*@NoRep*/ BlockScope[] shiftScopes; 
	...
	public BlockScope(BlockScope parent, boolean addToParentScope) {
		...
		if (addToParentScope) parent.addSubscope((/*@OwnPar*/ /*@NoRep*/ BlockScope)this);
	...
	public BlockScope(BlockScope parent, int variableCount) {
		...
		parent.addSubscope((/*@OwnPar*/ /*@NoRep*/ BlockScope)this);
		this.startIndex = parent.localIndex;
	}
	...
	public final void addAnonymousType(
		...
		/*@RepNorep*/ ClassScope anonymousClassScope = new ClassScope((/*@OwnPar*/ /*@NoRep*/ BlockScope)this, anonymousType);
	...
	public final void addLocalType(TypeDeclaration localType) {
		...
		/*@NoRep*/ Scope scope = (/*@OwnPar*/ /*@NoRep*/ BlockScope)this;
		do {
		...
		ClassScope localTypeScope = new ClassScope((/*@OwnPar*/ /*@NoRep*/ BlockScope)this, localType);
	...
	public final void addLocalVariable(LocalVariableBinding binding) {
		...
		binding.declaringScope = (/*@OwnPar*/ /*@NoRep*/ BlockScope)this;
				...
				if (binding instanceof ReferenceBinding) {
					if (!binding.isValidBinding())
						return new ProblemReferenceBinding(
							...
							binding.problemId());
					if (!((ReferenceBinding) binding).canBeSeenBy((/*@OwnPar*/ /*@NoRep*/ BlockScope)this))
						return new ProblemReferenceBinding(
							CharOperation.subarray(compoundName, 0, currentIndex),
	...
	public VariableBinding[] getEmulationPath(LocalVariableBinding outerLocalVariable) {
		...
		if (variableScope == null /*val$this$0*/ || currentMethodScope == variableScope.methodScope()) {
			return new /*@NoRep*/ VariableBinding[] { outerLocalVariable };
		...
		if (currentMethodScope.isInsideInitializerOrConstructor()
			...
			if ((syntheticArg = ((NestedTypeBinding) sourceType).getSyntheticArgument(outerLocalVariable)) != null) {
				return new /*@NoRep*/ VariableBinding[] { syntheticArg };
			}
		}
		...
		if (!currentMethodScope.isStatic) {
			...
			if ((syntheticField = sourceType.getSyntheticField(outerLocalVariable)) != null) {
				return new /*@NoRep*/ VariableBinding[] { syntheticField };
			}
		}
		return null;
	}
	...
	public Object[] getEmulationPath(
		...
		/*@NoRep*/ MethodScope currentMethodScope = this.methodScope();
		SourceTypeBinding sourceType = currentMethodScope.enclosingSourceType();
	...
	public final boolean isDuplicateLocalVariable(char[] name) {
		/*@NoRep*/ BlockScope current = (/*@OwnPar*/ /*@NoRep*/ BlockScope)this;
		while (true) {
			for (int i = 0; i < localIndex; i++) {
