...
public class Wildcard extends SingleTypeReference {
	...
	public void traverse(ASTVisitor visitor, /*@NoRep*/ BlockScope scope) {
		if (visitor.visit((/*@OwnPar*/ /*@NoRep*/ Wildcard)this, scope)) {
			if (this.bound != null) {
				this.bound.traverse(visitor, scope);
			}
		}
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ Wildcard)this, scope);
	}
