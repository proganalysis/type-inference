...
public class CompilationResult {
	...
	private /*@RepOwn*/ Map</*@RepRep*/ Object, /*@RepRep*/ Object> problemsMap;
	private /*@RepRep*/ Set firstErrors;
	...
	public /*@RepOwn*/ Map compiledTypes = new Hashtable(11);
	...
	public ClassFile[] getClassFiles() {
        /*@NoRep*/ org.eclipse.jdt.internal.compiler.ClassFile /*@OwnOwn*/ [] classFiles = new ClassFile[compiledTypes.size()];
		((/*@RepOwn*/ java.util.Collection) compiledTypes.values()).toArray(classFiles);
		return classFiles;	
	}
	...
	public CompilationResult tagAsAccepted(){
		...
		return (/*@OwnPar*/ /*@NoRep*/ CompilationResult)this;
	}
	...
	public String toString(){
		...
		if (this.compiledTypes != null){
			...
			/*@RepOwn*/ Iterator keys = this.compiledTypes.keySet().iterator();
			while (keys.hasNext()) {
