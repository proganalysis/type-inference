...
public RecoveredElement add(Block nestedBlockDeclaration, int bracketBalanceValue) {
	...
	RecoveredBlock element = new RecoveredBlock(nestedBlockDeclaration, (/*@OwnPar*/ /*@NoRep*/ RecoveredBlock)this, bracketBalanceValue);
	...
	return (/*@OwnPar*/ /*@NoRep*/ RecoveredBlock)this;	
}
/*
...
/*	
	...
	if ((localDeclaration.modifiers & ~AccFinal) != 0 // local var can only be final 
		...
		if (delegatedByParent){
			return (RecoveredBlock)this; //ignore
		} else {
...
*/	
	...
	if (this.blockDeclaration.sourceEnd != 0 
		...
		if (delegatedByParent) return (/*@OwnPar*/ /*@NoRep*/ RecoveredBlock)this; //ignore
		return this.parent.add(localDeclaration, bracketBalanceValue);
	}

	RecoveredLocalVariable element = new RecoveredLocalVariable(localDeclaration, (/*@OwnPar*/ /*@NoRep*/ RecoveredBlock)this, bracketBalanceValue);
...
public RecoveredElement add(Statement stmt, int bracketBalanceValue, boolean delegatedByParent) {
	...
	RecoveredStatement element = new RecoveredStatement(stmt, (/*@OwnPar*/ /*@NoRep*/ RecoveredBlock)this, bracketBalanceValue);
	this.attach(element);
...
public RecoveredElement add(TypeDeclaration typeDeclaration, int bracketBalanceValue, boolean delegatedByParent) {
	...
	RecoveredStatement element = new RecoveredType(typeDeclaration, (/*@OwnPar*/ /*@NoRep*/ RecoveredBlock)this, bracketBalanceValue);
	this.attach(element);
