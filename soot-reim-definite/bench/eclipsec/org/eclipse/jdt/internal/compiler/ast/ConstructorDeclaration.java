...
public class ConstructorDeclaration extends AbstractMethodDeclaration {
	...
	public void analyseCode(
		...
		if (this.binding != null && !this.binding.isUsed() && (this.binding.isPrivate() || (this.binding.declaringClass.tagBits & (TagBits.IsAnonymousType|TagBits.IsLocalType)) == TagBits.IsLocalType)) {
			if (!classScope.referenceCompilationUnit().compilationResult.hasSyntaxError) {
				scope.problemReporter().unusedPrivateConstructor((/*@OwnPar*/ /*@NoRep*/ ConstructorDeclaration)this);
			}
		}
		...
		try {
			ExceptionHandlingFlowContext constructorContext =
				new ExceptionHandlingFlowContext(
					...
					(/*@OwnPar*/ /*@NoRep*/ ConstructorDeclaration)this,
				...
				for (int i = 0, count = fields.length; i < count; i++) {
					...
					if ((!(field = fields[i]).isStatic())
						...
						scope.problemReporter().uninitializedBlankFinalField(
							field,
							isDefaultConstructor ? (ASTNode) scope.referenceType() : (/*@OwnPar*/ /*@NoRep*/ ConstructorDeclaration)this);
					}
				}
			}
			// check unreachable catch blocks
			constructorContext.complainIfUnusedExceptionHandlers((/*@OwnPar*/ /*@NoRep*/ ConstructorDeclaration)this);
		} catch (AbortMethod e) {
	...
	public void generateCode(ClassScope classScope, ClassFile classFile) {
		...
		if (ignoreFurtherInvestigation) {
			...
			classFile.addProblemConstructor((/*@OwnPar*/ /*@NoRep*/ ConstructorDeclaration)this, binding, problemsCopy);
			return;
		}
		try {
			...
			if (e.compilationResult == CodeStream.RESTART_IN_WIDE_MODE) {
				...
				try {
					...
					IProblem[] problemsCopy = new IProblem[problemsLength = problems.length];
					System.arraycopy(problems, 0, problemsCopy, 0, problemsLength);
					classFile.addProblemConstructor((/*@OwnPar*/ /*@NoRep*/ ConstructorDeclaration)this, binding, problemsCopy, problemResetPC);
				}
			} else {
				int problemsLength;
				IProblem[] problems =
	...
	private void internalGenerateCode(ClassScope classScope, ClassFile classFile) {
		...
		if ((!binding.isNative()) && (!binding.isAbstract())) {
			...
			codeStream.reset((/*@OwnPar*/ /*@NoRep*/ ConstructorDeclaration)this, classFile);
	...
	public boolean isRecursive(ArrayList visited) {
		...
		if (visited == null) { // lazy allocation
			...
			int index = visited.indexOf((/*@OwnPar*/ /*@NoRep*/ ConstructorDeclaration)this);
			if (index >= 0) return index == 0; // only blame if directly part of the cycle
		}
		visited.add((/*@OwnPar*/ /*@NoRep*/ ConstructorDeclaration)this);
	...
	public void parseStatements(Parser parser, CompilationUnitDeclaration unit) {
		...
		parser.parse((/*@OwnPar*/ /*@NoRep*/ ConstructorDeclaration)this, unit);
	...
	public void resolveStatements() {
		...
		if (!CharOperation.equals(this.scope.enclosingSourceType().sourceName, selector)){
			this.scope.problemReporter().missingReturnType((/*@OwnPar*/ /*@NoRep*/ ConstructorDeclaration)this);
		}
		...
		if ((this.modifiers & ExtraCompilerModifiers.AccSemicolonBody) != 0) {
			this.scope.problemReporter().methodNeedBody((/*@OwnPar*/ /*@NoRep*/ ConstructorDeclaration)this);		
		}
	...
	public void traverse(
		...
		if (visitor.visit((/*@OwnPar*/ /*@NoRep*/ ConstructorDeclaration)this, classScope)) {
		...
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ ConstructorDeclaration)this, classScope);
	}
	public TypeParameter[] typeParameters() {
