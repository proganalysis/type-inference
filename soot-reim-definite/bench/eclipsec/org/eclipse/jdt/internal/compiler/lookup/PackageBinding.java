...
public class PackageBinding extends Binding implements TypeConstants {
	...
	/*@RepRep*/ HashtableOfType knownTypes;
...
private PackageBinding findPackage(char[] name) {
	...
	PackageBinding subPackageBinding = new PackageBinding(subPkgCompoundName, (/*@OwnPar*/ /*@NoRep*/ PackageBinding)this, environment);
...
ReferenceBinding getType(char[] name) {
	...
	if (typeBinding == null) {
		if ((typeBinding = environment.askForType((/*@OwnPar*/ /*@NoRep*/ PackageBinding)this, name)) == null) {
