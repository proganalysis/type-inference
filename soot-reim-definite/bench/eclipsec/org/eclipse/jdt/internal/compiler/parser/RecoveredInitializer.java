...
public RecoveredElement add(Block nestedBlockDeclaration, int bracketBalanceValue) {
	...
	*/
	if (fieldDeclaration.declarationSourceEnd > 0
		...
		if (this.parent == null) return (/*@OwnPar*/ /*@NoRep*/ RecoveredInitializer)this; // ignore
	...
	initializerBody = new RecoveredBlock(nestedBlockDeclaration, (/*@OwnPar*/ /*@NoRep*/ RecoveredInitializer)this, bracketBalanceValue);
	if (nestedBlockDeclaration.sourceEnd == 0) return initializerBody;
	return (/*@OwnPar*/ /*@NoRep*/ RecoveredInitializer)this;
}
/*
...
public RecoveredElement add(FieldDeclaration newFieldDeclaration, int bracketBalanceValue) {
	...
	*/
	...
	return (/*@OwnPar*/ /*@NoRep*/ RecoveredInitializer)this; // ignore
}
/*
...
public RecoveredElement add(LocalDeclaration localDeclaration, int bracketBalanceValue) {
	...
	if (fieldDeclaration.declarationSourceEnd != 0 
		...
		if (parent == null) return (/*@OwnPar*/ /*@NoRep*/ RecoveredInitializer)this; // ignore
...
public RecoveredElement add(TypeDeclaration typeDeclaration, int bracketBalanceValue) {
	...
	RecoveredType element = new RecoveredType(typeDeclaration, (/*@OwnPar*/ /*@NoRep*/ RecoveredInitializer)this, bracketBalanceValue);
...
public RecoveredElement updateOnOpeningBrace(int braceStart, int braceEnd){
	bracketBalance++;
	return (/*@OwnPar*/ /*@NoRep*/ RecoveredInitializer)this; // request to restart
}
/*
