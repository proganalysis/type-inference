...
public class ArrayAllocationExpression extends Expression {
	...
	public /*@NoRep*/ Expression[] dimensions;
	...
	public TypeBinding resolveType(BlockScope scope) {
		...
		if (referenceType == VoidBinding) {
			scope.problemReporter().cannotAllocateVoidArray((/*@OwnPar*/ /*@NoRep*/ ArrayAllocationExpression)this);
			referenceType = null;
		}
		...
		loop: for (int i = dimensions.length; --i >= 0;) {
			if (dimensions[i] != null) {
				...
				scope.problemReporter().incorrectLocationForNonEmptyDimension((/*@OwnPar*/ /*@NoRep*/ ArrayAllocationExpression)this, explicitDimIndex);
				break loop;
			}
		}
		...
		if (initializer == null) {
			if (explicitDimIndex < 0) {
				scope.problemReporter().mustDefineDimensionsOrInitializer((/*@OwnPar*/ /*@NoRep*/ ArrayAllocationExpression)this);
			}
			...
			if (referenceType != null && !referenceType.isReifiable()) {
			    scope.problemReporter().illegalGenericArray(referenceType, (/*@OwnPar*/ /*@NoRep*/ ArrayAllocationExpression)this);
			}
		} else if (explicitDimIndex >= 0) {
			scope.problemReporter().cannotDefineDimensionsAndInitializer((/*@OwnPar*/ /*@NoRep*/ ArrayAllocationExpression)this);
		}
		...
		if (referenceType != null) {
			if (dimensions.length > 255) {
				scope.problemReporter().tooManyDimensions((/*@OwnPar*/ /*@NoRep*/ ArrayAllocationExpression)this);
			}
	...
	public void traverse(ASTVisitor visitor, BlockScope scope) {
		...
		if (visitor.visit((/*@OwnPar*/ /*@NoRep*/ ArrayAllocationExpression)this, scope)) {
		...
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ ArrayAllocationExpression)this, scope);
	}
}
