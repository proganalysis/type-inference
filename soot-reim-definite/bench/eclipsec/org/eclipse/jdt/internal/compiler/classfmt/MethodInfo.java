...
public char[] getGenericSignature() {
	if (this.signatureUtf8Offset != -1) {
		if (this.signature == null) {
			...
			((/*@checkers.inference.reim.quals.Mutable*/ MethodInfo) this).signature = utf8At(this.signatureUtf8Offset + 3, u2At(this.signatureUtf8Offset + 1));
		}
...
public char[] getMethodDescriptor() {
	if (descriptor == null) {
		...
		((/*@checkers.inference.reim.quals.Mutable*/ MethodInfo) this).descriptor = utf8At(utf8Offset + 3, u2At(utf8Offset + 1));
	}
	return descriptor;
}
/**
...
public int getModifiers() {
	if (this.accessFlags == -1) {
		...
		((/*@checkers.inference.reim.quals.Mutable*/ MethodInfo) this).accessFlags = u2At(0);
		((/*@checkers.inference.reim.quals.Mutable*/ MethodInfo) this).readModifierRelatedAttributes();
	}
...
public char[] getSelector() {
	if (name == null) {
		...
		((/*@checkers.inference.reim.quals.Mutable*/ MethodInfo) this).name = utf8At(utf8Offset + 3, u2At(utf8Offset + 1));
	}
	return name;
}
