...
public class QualifiedNameReference extends NameReference {
	...
	/*@NoRep*/ org.eclipse.jdt.internal.compiler.lookup.SyntheticMethodBinding /*@RepRep*/ [] syntheticReadAccessors;
	public TypeBinding genericCast;
	public /*@NoRep*/ org.eclipse.jdt.internal.compiler.lookup.TypeBinding /*@RepRep*/ [] otherGenericCasts;
				...
				if (this.indexOfFirstFieldBinding == 1) { // was an implicit reference to the first field binding
					...
					if (declaringClass.isEnum()) {
						...
						if (lastFieldBinding.isStatic()
							...
							currentScope.problemReporter().enumStaticFieldUsedDuringInitialization(lastFieldBinding, (/*@OwnPar*/ /*@NoRep*/ QualifiedNameReference)this);
						}
					}				
				}				
				...
				if (lastFieldBinding.isBlankFinal()
					...
					if (!flowInfo.isDefinitelyAssigned(lastFieldBinding)) {
						currentScope.problemReporter().uninitializedBlankFinalField(
							lastFieldBinding,
							(/*@OwnPar*/ /*@NoRep*/ QualifiedNameReference)this);
					}
				}
				break;
			case Binding.LOCAL :
				...
				if (!flowInfo
					...
					currentScope.problemReporter().uninitializedLocalVariable(localBinding, (/*@OwnPar*/ /*@NoRep*/ QualifiedNameReference)this);
				}
		...
		if (lastFieldBinding.isFinal()) {
			...
			if (lastFieldBinding.isBlankFinal()
				...
				if (flowInfo.isPotentiallyAssigned(lastFieldBinding)) {
					currentScope.problemReporter().duplicateInitializationOfBlankFinalField(lastFieldBinding, (/*@OwnPar*/ /*@NoRep*/ QualifiedNameReference)this);
				} else {
					flowContext.recordSettingFinal(lastFieldBinding, (/*@OwnPar*/ /*@NoRep*/ QualifiedNameReference)this, flowInfo);
				}
				flowInfo.markAsDefinitelyAssigned(lastFieldBinding);
			} else {
				currentScope.problemReporter().cannotAssignToFinalField(lastFieldBinding, (/*@OwnPar*/ /*@NoRep*/ QualifiedNameReference)this);
				...
				if (this.indexOfFirstFieldBinding == 1) { // was an implicit reference to the first field binding
					...
					if (declaringClass.isEnum()) {
						...
						if (fieldBinding.isStatic()
								...
								&& !methodScope.isStatic
								&& methodScope.isInsideInitializerOrConstructor()) {
							currentScope.problemReporter().enumStaticFieldUsedDuringInitialization(fieldBinding, (/*@OwnPar*/ /*@NoRep*/ QualifiedNameReference)this);
						}
					}				
					...
					if (fieldBinding.isBlankFinal()
						...
						currentScope.problemReporter().uninitializedBlankFinalField(fieldBinding, (/*@OwnPar*/ /*@NoRep*/ QualifiedNameReference)this);
					}
				}
				break;
	...
	public TypeBinding checkFieldAccess(BlockScope scope) {
		...
		if (this.indexOfFirstFieldBinding == 1
			...
			scope.problemReporter().forwardReference((/*@OwnPar*/ /*@NoRep*/ QualifiedNameReference)this, 0, methodScope.enclosingSourceType());
		}
			...
			case Binding.FIELD :
				...
				if (needValue && !lastFieldBinding.isStatic()) {
					...
					if ((bits & DepthMASK) != 0) {
						...
						codeStream.generateOuterAccess(emulationPath, (/*@OwnPar*/ /*@NoRep*/ QualifiedNameReference)this, targetType, currentScope);
					} else {
			...
			case Binding.LOCAL : // reading the first local variable
				...
				if (localConstant != Constant.NotAConstant) {
					...
					if ((bits & DepthMASK) != 0) {
						...
						codeStream.generateOuterAccess(path, (/*@OwnPar*/ /*@NoRep*/ QualifiedNameReference)this, localBinding, currentScope);
					} else {
	...
	public TypeBinding getOtherFieldBindings(BlockScope scope) {
		...
		if ((bits & Binding.FIELD) != 0) {
			...
			if (!field.isStatic()) {
				...
				if (indexOfFirstFieldBinding > 1  //accessing to a field using a type as "receiver" is allowed only with static field
					...
					scope.problemReporter().staticFieldAccessToNonStaticVariable((/*@OwnPar*/ /*@NoRep*/ QualifiedNameReference)this, field);
					return null;
				 }
			} else {
				...
				if (indexOfFirstFieldBinding > 1 
					...
					scope.problemReporter().indirectAccessToStaticField((/*@OwnPar*/ /*@NoRep*/ QualifiedNameReference)this, field);
				}
			}
			// only last field is actually a write access if any
			if (isFieldUseDeprecated(field, scope, (this.bits & IsStrictlyAssigned) !=0 && indexOfFirstFieldBinding == length))
				scope.problemReporter().deprecatedField(field, (/*@OwnPar*/ /*@NoRep*/ QualifiedNameReference)this);
		} else {
			field = null;
		}
		...
		while (index < length) {
			...
			field = scope.getField(type.capture(scope, (int)this.sourcePositions[index]), token, (/*@OwnPar*/ /*@NoRep*/ QualifiedNameReference)this);
			...
			if (field.isValidBinding()) {
				...
				if (field.isStatic()) {
					...
					scope.problemReporter().nonStaticAccessToStaticField((/*@OwnPar*/ /*@NoRep*/ QualifiedNameReference)this, field);
					// indirect static reference ?
				...
				scope.problemReporter().invalidField((/*@OwnPar*/ /*@NoRep*/ QualifiedNameReference)this, field, index, type);
				setDepth(firstDepth);
				return null;
			}
		}
	...
	public void manageSyntheticAccessIfNecessary(
		...
		if (fieldBinding.isPrivate()) { // private access
			...
			if (someCodegenBinding.declaringClass != currentScope.enclosingSourceType()) {
				...
				currentScope.problemReporter().needToEmulateFieldAccess(someCodegenBinding, (/*@OwnPar*/ /*@NoRep*/ QualifiedNameReference)this, index >= 0 /*read-access?*/);
				return;
			}
	...
	public TypeBinding reportError(BlockScope scope) {
		if (binding instanceof ProblemFieldBinding) {
			scope.problemReporter().invalidField((/*@OwnPar*/ /*@NoRep*/ QualifiedNameReference)this, (FieldBinding) binding);
		} else if (binding instanceof ProblemReferenceBinding) {
			scope.problemReporter().invalidType((/*@OwnPar*/ /*@NoRep*/ QualifiedNameReference)this, (TypeBinding) binding);
		} else {
			scope.problemReporter().unresolvableReference((/*@OwnPar*/ /*@NoRep*/ QualifiedNameReference)this, binding);
		}
		return null;
	}
	public TypeBinding resolveType(BlockScope scope) {
		...
		if ((this.codegenBinding = this.binding = scope.getBinding(tokens, bits & RestrictiveFlagMASK, (/*@OwnPar*/ /*@NoRep*/ QualifiedNameReference)this, true /*resolve*/)).isValidBinding()) {
			switch (bits & RestrictiveFlagMASK) {
				...
				case Binding.TYPE | Binding.VARIABLE :
					...
					if (binding instanceof FieldBinding) {
						...
						if (!fieldBinding.isStatic() 
							...
							scope.problemReporter().unqualifiedFieldAccess((/*@OwnPar*/ /*@NoRep*/ QualifiedNameReference)this, fieldBinding);
						}
						bits &= ~RestrictiveFlagMASK; // clear bits
						bits |= Binding.FIELD;
						...
						if (indexOfFirstFieldBinding > 1) {
							if (isTypeUseDeprecated(this.actualReceiverType, scope))
								scope.problemReporter().deprecatedType(this.actualReceiverType, (/*@OwnPar*/ /*@NoRep*/ QualifiedNameReference)this);
						}
				...
				case Binding.TYPE : //=============only type ==============
					...
					if (isTypeUseDeprecated(type, scope))
						scope.problemReporter().deprecatedType(type, (/*@OwnPar*/ /*@NoRep*/ QualifiedNameReference)this);
	...
	public void traverse(ASTVisitor visitor, BlockScope scope) {
		visitor.visit((/*@OwnPar*/ /*@NoRep*/ QualifiedNameReference)this, scope);
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ QualifiedNameReference)this, scope);
	}
