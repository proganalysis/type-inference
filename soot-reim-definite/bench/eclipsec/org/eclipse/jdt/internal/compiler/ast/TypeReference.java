...
protected void reportInvalidType(Scope scope) {
	scope.problemReporter().invalidType((/*@OwnPar*/ /*@NoRep*/ TypeReference)this, this.resolvedType);
}
protected void reportDeprecatedType(Scope scope) {
	scope.problemReporter().deprecatedType(this.resolvedType, (/*@OwnPar*/ /*@NoRep*/ TypeReference)this);
}
