...
public class RawTypeBinding extends ParameterizedTypeBinding {
	...
	public ParameterizedMethodBinding createParameterizedMethod(MethodBinding originalMethod) {
		...
		return new ParameterizedGenericMethodBinding(originalMethod, (/*@OwnPar*/ /*@NoRep*/ RawTypeBinding)this, this.environment);
	}
    ...
    public boolean isEquivalentTo(TypeBinding otherType) {
	    ...
	    switch(otherType.kind()) {
	    	...
	    	case Binding.WILDCARD_TYPE :
	        	return ((WildcardBinding) otherType).boundCheck((/*@OwnPar*/ /*@NoRep*/ RawTypeBinding)this);
