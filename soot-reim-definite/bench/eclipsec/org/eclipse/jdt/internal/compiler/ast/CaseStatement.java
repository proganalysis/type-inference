...
public class CaseStatement extends Statement {
	...
	public Constant resolveCase(BlockScope scope, TypeBinding switchExpressionType, SwitchStatement switchStatement) {
	    ...
	    scope.enclosingCase = (/*@OwnPar*/ /*@NoRep*/ CaseStatement)this; // record entering in a switch case block
	    
		if (constantExpression == null) {
			// remember the default case into the associated switch statement
			if (switchStatement.defaultCase != null)
				scope.problemReporter().duplicateDefaultCase((/*@OwnPar*/ /*@NoRep*/ CaseStatement)this);
	
			// on error the last default will be the selected one ...	
			switchStatement.defaultCase = (/*@OwnPar*/ /*@NoRep*/ CaseStatement)this;
			return Constant.NotAConstant;
		}
		// add into the collection of cases of the associated switch statement
		switchStatement.cases[switchStatement.caseCount++] = (/*@OwnPar*/ /*@NoRep*/ CaseStatement)this;
	...
	public void traverse(
		...
		if (visitor.visit((/*@OwnPar*/ /*@NoRep*/ CaseStatement)this, blockScope)) {
			if (constantExpression != null) constantExpression.traverse(visitor, blockScope);
		}
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ CaseStatement)this, blockScope);
	}
}
