...
public class TryStatement extends SubRoutineStatement {
	...
	public /*@NoRep*/ Block[] catchBlocks;
	public /*@NoRep*/ org.eclipse.jdt.internal.compiler.ast.Argument [] catchArguments;
	...
	public FlowInfo analyseCode(
		...
		if (subRoutineStartLabel == null) {
			...
			insideSubContext = new InsideSubRoutineFlowContext(flowContext, (/*@OwnPar*/ /*@NoRep*/ TryStatement)this);
			subInfo = 
				finallyBlock
					.analyseCode(
						currentScope,
		...
		handlingContext.complainIfUnusedExceptionHandlers(scope, (/*@OwnPar*/ /*@NoRep*/ TryStatement)this);
	...
	public void generateCode(BlockScope currentScope, CodeStream codeStream) {
		...
		if (tryBlockHasSomeCode) {
			...
			*/
			...
			/*@RepRep*/ ExceptionLabel naturalExitExceptionHandler = 
...
//						codeStream.updateLastRecordedEndPC(position);
	...
	public void resolve(BlockScope upperScope) {
		...
		if (this.catchBlocks != null) {
			...
			/*@NoRep*/ org.eclipse.jdt.internal.compiler.lookup.TypeBinding /*@RepRep*/ [] argumentTypes = new TypeBinding[length];
			...
			for (int i = 0; i < length; i++) {
				...
				for (int j = 0; j < i; j++) {
					if (caughtExceptionTypes[i].isCompatibleWith(argumentTypes[j])) {
						scope.problemReporter().wrongSequenceOfExceptionTypesError((/*@OwnPar*/ /*@NoRep*/ TryStatement)this, caughtExceptionTypes[i], i, argumentTypes[j]);
					}
				}
			}
		} else {
	...
	public void traverse(
		...
		if (visitor.visit((/*@OwnPar*/ /*@NoRep*/ TryStatement)this, blockScope)) {
		...
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ TryStatement)this, blockScope);
	}
}
