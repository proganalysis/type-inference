...
void setResolvedType(ReferenceBinding targetType, LookupEnvironment environment) {
	...
	if (this.wrappers != null)
		for (int i = 0, l = this.wrappers.length; i < l; i++)
			this.wrappers[i].swapUnresolved((/*@OwnPar*/ /*@NoRep*/ UnresolvedReferenceBinding)this, targetType, environment);
	environment.updateCaches((/*@OwnPar*/ /*@NoRep*/ UnresolvedReferenceBinding)this, targetType);
}
