...
public RecoveredElement add(AbstractMethodDeclaration methodDeclaration, int bracketBalanceValue) {
	...
	return (/*@OwnPar*/ /*@NoRep*/ RecoveredUnit)this; // ignore
}
/*
...
public RecoveredElement add(ImportReference importReference, int bracketBalanceValue) {
	...
	RecoveredImport element = new RecoveredImport(importReference, (/*@OwnPar*/ /*@NoRep*/ RecoveredUnit)this, bracketBalanceValue);
	...
	return (/*@OwnPar*/ /*@NoRep*/ RecoveredUnit)this;		
}
public RecoveredElement add(TypeDeclaration typeDeclaration, int bracketBalanceValue) {
	...
	RecoveredType element = new RecoveredType(typeDeclaration, (/*@OwnPar*/ /*@NoRep*/ RecoveredUnit)this, bracketBalanceValue);
...
public CompilationUnitDeclaration updatedCompilationUnitDeclaration(){
	...
	if (this.importCount > 0){
		/*@NoRep*/ org.eclipse.jdt.internal.compiler.ast.ImportReference /*@OwnOwn*/ [] importRefences = new ImportReference[this.importCount];
		for (int i = 0; i < this.importCount; i++){
