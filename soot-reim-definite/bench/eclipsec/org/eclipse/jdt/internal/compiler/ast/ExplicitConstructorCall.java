...
public class ExplicitConstructorCall extends Statement implements InvocationSite {
		...
		try {
			...
			if (targetType.isNestedType()) {
				codeStream.generateSyntheticEnclosingInstanceValues(
					...
					(/*@OwnPar*/ /*@NoRep*/ ExplicitConstructorCall)this);
			}
			// generate arguments
	...
	public void manageSyntheticAccessIfNecessary(BlockScope currentScope, FlowInfo flowInfo) {
		...
		if (binding.isPrivate() && accessMode != This) {
			...
			if (currentScope.compilerOptions().isPrivateConstructorAccessChangingVisibility) {
				...
				currentScope.problemReporter().needToEmulateMethodAccess(this.codegenBinding, (/*@OwnPar*/ /*@NoRep*/ ExplicitConstructorCall)this);
			}
		}
	}
	...
	public void resolve(BlockScope scope) {
		...
		try {
			...
			if (methodDeclaration == null 
				...
				scope.problemReporter().invalidExplicitConstructorCall((/*@OwnPar*/ /*@NoRep*/ ExplicitConstructorCall)this);
				return;
			}
			...
			if (this.accessMode == Super && receiverType.erasure().id == T_JavaLangEnum) {
				scope.problemReporter().cannotInvokeSuperConstructorInEnum((/*@OwnPar*/ /*@NoRep*/ ExplicitConstructorCall)this, methodScope.referenceMethod().binding);
			}
			...
			if (arguments != null) {
				...
				if (argHasError) {
					...
					this.binding = scope.findMethod(receiverType, TypeConstants.INIT, pseudoArgs, (/*@OwnPar*/ /*@NoRep*/ ExplicitConstructorCall)this);
					return;
				}
			...
			if ((binding = scope.getConstructor(receiverType, argumentTypes, (/*@OwnPar*/ /*@NoRep*/ ExplicitConstructorCall)this)).isValidBinding()) {
				if (isMethodUseDeprecated(this.binding, scope, this.accessMode != ImplicitSuper))
					scope.problemReporter().deprecatedMethod(binding, (/*@OwnPar*/ /*@NoRep*/ ExplicitConstructorCall)this);
				checkInvocationArguments(scope, null, receiverType, binding, this.arguments, argumentTypes, argsContainCast, (/*@OwnPar*/ /*@NoRep*/ ExplicitConstructorCall)this);
				...
				scope.problemReporter().invalidConstructor((/*@OwnPar*/ /*@NoRep*/ ExplicitConstructorCall)this, binding);
			}
		} finally {
	...
	public void traverse(ASTVisitor visitor, BlockScope scope) {
		...
		if (visitor.visit((/*@OwnPar*/ /*@NoRep*/ ExplicitConstructorCall)this, scope)) {
		...
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ ExplicitConstructorCall)this, scope);
	}
}
