...
public class Util implements SuffixConstants {
	...
	*/
	...
	public static char[] getInputStreamAsCharArray(InputStream stream, int length, String encoding)
		throws IOException {
		/*@RepOwn*/ InputStreamReader reader = null;
		try {
	 ...
	 */
	public static byte[] getZipEntryByteContent(ZipEntry ze, /*@OwnOwn*/ ZipFile zip)
		throws IOException {
	 ...
	 */
	public final static boolean isExcluded(char[] path, char /*@RepRep*/ [] /*@NoRep*/ [] inclusionPatterns, char /*@RepRep*/ [] /*@NoRep*/ [] exclusionPatterns, boolean isFolderPath) {
	 ...
	 * Converts an array of Objects into String.
	 */
	public static String toString(Object[] objects, /*@OwnOwn*/ Displayable renderer) {
