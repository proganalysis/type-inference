...
public class OR_OR_Expression extends BinaryExpression {
			...
			if (leftIsConst && leftIsTrue) {
				...
				if (trueLabel.hasForwardReferences()) {
					if ((bits & IsReturnedValue) != 0) {
						...
						codeStream.generateReturnBytecode((/*@OwnPar*/ /*@NoRep*/ OR_OR_Expression)this);
						trueLabel.place();
						codeStream.iconst_1();
					} else {
	...
	public void traverse(ASTVisitor visitor, BlockScope scope) {
		if (visitor.visit((/*@OwnPar*/ /*@NoRep*/ OR_OR_Expression)this, scope)) {
			left.traverse(visitor, scope);
			right.traverse(visitor, scope);
		}
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ OR_OR_Expression)this, scope);
	}
}
