...
public class QualifiedTypeReference extends TypeReference {
	...
	protected TypeBinding findNextTypeBinding(int tokenIndex, Scope scope, PackageBinding packageBinding) {
		try {
			...
			e.updateContext((/*@OwnPar*/ /*@NoRep*/ QualifiedTypeReference)this, scope.referenceCompilationUnit().compilationResult);
			throw e;
		}
	}
	...
	protected TypeBinding getTypeBinding(Scope scope) {
		...
		for (int i = packageBinding == null ? 0 : packageBinding.compoundName.length, max = this.tokens.length; i < max; i++) {
			...
			if (isClassScope)
				if (((ClassScope) scope).detectHierarchyCycle(this.resolvedType, (/*@OwnPar*/ /*@NoRep*/ QualifiedTypeReference)this, null)) // must connect hierarchy to find inherited member types
					return null;
	...
	public void traverse(ASTVisitor visitor, BlockScope scope) {
		...
		visitor.visit((/*@OwnPar*/ /*@NoRep*/ QualifiedTypeReference)this, scope);
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ QualifiedTypeReference)this, scope);
	}
