...
public class BreakStatement extends BranchStatement {
	...
	public FlowInfo analyseCode(
		...
		if (targetContext == null) {
			if (label == null) {
				currentScope.problemReporter().invalidBreak((/*@OwnPar*/ /*@NoRep*/ BreakStatement)this);
			} else {
				currentScope.problemReporter().undefinedLabel((/*@OwnPar*/ /*@NoRep*/ BreakStatement)this); 
			}
	...
	public void traverse(
		...
		visitor.visit((/*@OwnPar*/ /*@NoRep*/ BreakStatement)this, blockscope);
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ BreakStatement)this, blockscope);
	}
}
