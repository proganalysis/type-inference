...
public final class Messages {
	private static class MessagesProperties extends Properties {
		...
		private final /*@ParNorep*/ Map</*@RepRep*/ Object, /*@RepRep*/ Object> fields;
		...
		public synchronized Object put(Object key, Object value) {
			try {
				/*@ParNorep*/ Field field = (Field) fields.get(key);
				if (field == null) {
					return null;
				}
	...
	private static String[] buildVariants(String root) {
		if (nlSuffixes == null) {
			...
			/*@RepRep*/ ArrayList result = new ArrayList(4);
			int lastSeparator;
			while (true) {
	...
	public static void load(final String bundleName, final ClassLoader loader, final Field[] fields) {
		...
		for (int i = variants.length; --i >= 0;) {
			...
			if (input == null)
				continue;
			try {
				final /*@RepRep*/ MessagesProperties properties = new MessagesProperties(fields, bundleName);
