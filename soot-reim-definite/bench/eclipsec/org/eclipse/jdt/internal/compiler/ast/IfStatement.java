...
public class IfStatement extends Statement {
	...
	public IfStatement(/*@NoRep*/ Expression condition, /*@OwnOwn*/ Statement thenStatement, 	int sourceStart, int sourceEnd) {
	...
	public void traverse(
		...
		if (visitor.visit((/*@OwnPar*/ /*@NoRep*/ IfStatement)this, blockScope)) {
		...
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ IfStatement)this, blockScope);
	}
}
