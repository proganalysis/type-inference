...
public class FieldDeclaration extends AbstractVariableDeclaration {
	...
	public FlowInfo analyseCode(
		...
		if (this.binding != null && !this.binding.isUsed()) {
			if (this.binding.isPrivate() || (this.binding.declaringClass != null && this.binding.declaringClass.isLocalType())) {
				if (!initializationScope.referenceCompilationUnit().compilationResult.hasSyntaxError) {
					initializationScope.problemReporter().unusedPrivateField((/*@OwnPar*/ /*@NoRep*/ FieldDeclaration)this);
				}
			}
		}
		...
		if (this.binding != null
			...
			initializationScope.problemReporter().unexpectedStaticModifierForField(
				...
				(/*@OwnPar*/ /*@NoRep*/ FieldDeclaration)this);
		}
		...
		if (!this.hasBeenResolved && this.binding != null && this.binding.isValidBinding()) {
			...
			if (classScope != null) {
				...
				if (declaringType.superclass != null) {
					Binding existingVariable = classScope.findField(declaringType.superclass, this.name, (/*@OwnPar*/ /*@NoRep*/ FieldDeclaration)this,  false /*do not resolve hidden field*/);
					if (existingVariable != null && this.binding != existingVariable && existingVariable.isValidBinding()){
						initializationScope.problemReporter().fieldHiding((/*@OwnPar*/ /*@NoRep*/ FieldDeclaration)this, existingVariable);
				...
				if (checkLocal) {
					...
					if (outerScope.kind != Scope.COMPILATION_UNIT_SCOPE) {
						Binding existingVariable = outerScope.getBinding(this.name, Binding.VARIABLE, (/*@OwnPar*/ /*@NoRep*/ FieldDeclaration)this, false /*do not resolve hidden field*/);
						if (existingVariable != null && this.binding != existingVariable && existingVariable.isValidBinding()
			...
			try {
				...
				if ((this.binding.getAnnotationTagBits() & TagBits.AnnotationDeprecated) == 0
					...
					initializationScope.problemReporter().missingDeprecatedAnnotationForField((/*@OwnPar*/ /*@NoRep*/ FieldDeclaration)this);
				}						
				...
				if (this.initialization == null) {
					...
					if (this.initialization instanceof ArrayInitializer) {
						...
						if (this.initialization.isConstantValueOfTypeAssignableToType(initializationType, fieldType)
							...
							initializationScope.problemReporter().typeMismatchError(initializationType, fieldType, (/*@OwnPar*/ /*@NoRep*/ FieldDeclaration)this);
						}
	...
	public void traverse(ASTVisitor visitor, MethodScope scope) {
		...
		if (visitor.visit((/*@OwnPar*/ /*@NoRep*/ FieldDeclaration)this, scope)) {
		...
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ FieldDeclaration)this, scope);
	}
}
