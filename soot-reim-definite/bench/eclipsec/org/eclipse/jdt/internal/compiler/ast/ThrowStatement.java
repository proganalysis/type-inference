...
public class ThrowStatement extends Statement {
	...
	public FlowInfo analyseCode(BlockScope currentScope, FlowContext flowContext, FlowInfo flowInfo) {
		...
		flowContext.checkExceptionHandlers(exceptionType, (/*@OwnPar*/ /*@NoRep*/ ThrowStatement)this, flowInfo, currentScope);
	...
	public void resolve(BlockScope scope) {
		...
		if (exceptionType == NullBinding
			...
			scope.problemReporter().cannotThrowNull((/*@OwnPar*/ /*@NoRep*/ ThrowStatement)this);
	 	}
		exception.computeConversion(scope, exceptionType, exceptionType);
	}

	public void traverse(ASTVisitor visitor, BlockScope blockScope) {
		if (visitor.visit((/*@OwnPar*/ /*@NoRep*/ ThrowStatement)this, blockScope))
			exception.traverse(visitor, blockScope);
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ ThrowStatement)this, blockScope);
	}
}
