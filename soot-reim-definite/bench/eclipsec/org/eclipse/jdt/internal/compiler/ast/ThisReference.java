...
public class ThisReference extends Reference {
	...
	public boolean checkAccess(MethodScope methodScope) {
		...
		if (methodScope.isConstructorCall) {
			methodScope.problemReporter().fieldsOrThisBeforeConstructorInvocation((/*@OwnPar*/ /*@NoRep*/ ThisReference)this);
			return false;
		}
	
		// static may not refer to this/super
		if (methodScope.isStatic) {
			methodScope.problemReporter().errorThisSuperInStatic((/*@OwnPar*/ /*@NoRep*/ ThisReference)this);
			return false;
		}
		return true;
	}
	...
	public void traverse(ASTVisitor visitor, BlockScope blockScope) {
		...
		visitor.visit((/*@OwnPar*/ /*@NoRep*/ ThisReference)this, blockScope);
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ ThisReference)this, blockScope);
	}
}
