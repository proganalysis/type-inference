...
public class AND_AND_Expression extends BinaryExpression {
			...
			if (leftIsConst && !leftIsTrue) {
				...
				if (falseLabel.hasForwardReferences()) {
					if ((bits & IsReturnedValue) != 0) {
						...
						codeStream.generateReturnBytecode((/*@OwnPar*/ /*@NoRep*/ AND_AND_Expression)this);
						falseLabel.place();
						codeStream.iconst_0();
					} else {
	...
	public void traverse(ASTVisitor visitor, BlockScope scope) {
		if (visitor.visit((/*@OwnPar*/ /*@NoRep*/ AND_AND_Expression)this, scope)) {
			left.traverse(visitor, scope);
			right.traverse(visitor, scope);
		}
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ AND_AND_Expression)this, scope);
	}
}
