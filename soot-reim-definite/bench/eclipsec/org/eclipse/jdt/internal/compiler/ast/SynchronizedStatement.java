...
public class SynchronizedStatement extends SubRoutineStatement {
	...
	public FlowInfo analyseCode(
		...
		flowInfo =
			block.analyseCode(
				scope,
				new InsideSubRoutineFlowContext(flowContext, (/*@OwnPar*/ /*@NoRep*/ SynchronizedStatement)this),
	...
	public void traverse(
		...
		if (visitor.visit((/*@OwnPar*/ /*@NoRep*/ SynchronizedStatement)this, blockScope)) {
			expression.traverse(visitor, scope);
			block.traverse(visitor, scope);
		}
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ SynchronizedStatement)this, blockScope);
	}
}
