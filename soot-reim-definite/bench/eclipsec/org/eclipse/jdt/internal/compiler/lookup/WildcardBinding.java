...
public class WildcardBinding extends ReferenceBinding {
	...
	public WildcardBinding(ReferenceBinding genericType, int rank, TypeBinding bound, TypeBinding[] otherBounds, int boundKind, LookupEnvironment environment) {
		...
		if (genericType instanceof UnresolvedReferenceBinding)
			((UnresolvedReferenceBinding) genericType).addWrapper((/*@OwnPar*/ /*@NoRep*/ WildcardBinding)this);
		if (bound instanceof UnresolvedReferenceBinding)
			((UnresolvedReferenceBinding) bound).addWrapper((/*@OwnPar*/ /*@NoRep*/ WildcardBinding)this);
...
//						}
    ...
    public char[] readableName() {
        switch (this.boundKind) {
            ...
            case Wildcard.EXTENDS :
            	...
            	/*@RepRep*/ StringBuffer buffer = new StringBuffer(10);
	...
	ReferenceBinding resolve() {
		if ((this.tagBits & HasUnresolvedTypeVariables) == 0)
			return (/*@OwnPar*/ /*@NoRep*/ WildcardBinding)this;
