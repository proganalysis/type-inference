...
public class Javadoc extends ASTNode {
	...
	public /*@NoRep*/ JavadocSingleNameReference[] paramReferences; // @param
	public /*@NoRep*/ JavadocSingleTypeReference[] paramTypeParameters; // @param
	public /*@NoRep*/ org.eclipse.jdt.internal.compiler.ast.TypeReference /*@OwnOwn*/ [] exceptionReferences; // @throws, @exception
	public JavadocReturnStatement returnStatement; // @return
	public /*@NoRep*/ org.eclipse.jdt.internal.compiler.ast.Expression /*@OwnOwn*/ [] seeReferences; // @see
	public long inheritedPositions = -1;
	// bug https://bugs.eclipse.org/bugs/show_bug.cgi?id=51600
	// Store param references for tag with invalid syntax
	public /*@NoRep*/ org.eclipse.jdt.internal.compiler.ast.JavadocSingleNameReference /*@OwnOwn*/ [] invalidParameters; // @param
	...
	private void resolveParamTags(MethodScope methScope, boolean reportMissing) {
		...
		if (paramTagsSize == 0) {
			...
			/*@NoRep*/ org.eclipse.jdt.internal.compiler.lookup.LocalVariableBinding /*@RepRep*/ [] bindings = new LocalVariableBinding[paramTagsSize];
			int maxBindings = 0;
	...
	private void resolveTypeParameterTags(Scope scope, boolean reportMissing) {
		...
		// Otherwise verify that all param tags match type parameters
			...
			/*@NoRep*/ org.eclipse.jdt.internal.compiler.lookup.TypeVariableBinding /*@RepRep*/ [] bindings = new TypeVariableBinding[paramTypeParamLength];
	...
	private void resolveThrowsTags(MethodScope methScope, boolean reportMissing) {
		...
		if (throwsTagsLength == 0) {
			...
			int maxRef = 0;
			/*@NoRep*/ org.eclipse.jdt.internal.compiler.ast.TypeReference /*@RepRep*/ [] typeReferences = new TypeReference[throwsTagsLength];
