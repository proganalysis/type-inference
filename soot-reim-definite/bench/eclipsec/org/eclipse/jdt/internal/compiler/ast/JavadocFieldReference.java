	...
	*/
	...
	protected TypeBinding internalResolveType(Scope scope) {
		...
		Binding fieldBinding = (this.receiver != null && this.receiver.isThis())
			? scope.classScope().getBinding(this.token, this.bits & RestrictiveFlagMASK, (/*@OwnPar*/ /*@NoRep*/ JavadocFieldReference)this, true /*resolve*/)
			: scope.getField(this.receiverType, this.token, (/*@OwnPar*/ /*@NoRep*/ JavadocFieldReference)this);
		...
		if (isFieldUseDeprecated(this.binding, scope, (this.bits & IsStrictlyAssigned) != 0)) {
			scope.problemReporter().javadocDeprecatedField(this.binding, (/*@OwnPar*/ /*@NoRep*/ JavadocFieldReference)this, scope.getDeclarationModifiers());
		}
	...
	public void traverse(ASTVisitor visitor, BlockScope scope) {
		...
		if (visitor.visit((/*@OwnPar*/ /*@NoRep*/ JavadocFieldReference)this, scope)) {
			if (this.receiver != null) {
				this.receiver.traverse(visitor, scope);
			}
		}
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ JavadocFieldReference)this, scope);
	}
}
