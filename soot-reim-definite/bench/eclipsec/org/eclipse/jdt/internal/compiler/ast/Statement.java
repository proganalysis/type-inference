...
public abstract class Statement extends ASTNode {
	...
	public boolean complainIfUnreachable(FlowInfo flowInfo, BlockScope scope, boolean didAlreadyComplain) {
		...
		if ((flowInfo.reachMode() & FlowInfo.UNREACHABLE) != 0) {
			...
			if (!didAlreadyComplain && reported) {
				scope.problemReporter().unreachableCode((/*@OwnPar*/ /*@NoRep*/ Statement)this);
			}
	 ...
	 */
	public void generateArguments(MethodBinding binding, /*@NoRep*/ org.eclipse.jdt.internal.compiler.ast.Expression /*@OwnOwn*/ [] arguments, BlockScope currentScope, CodeStream codeStream) {
