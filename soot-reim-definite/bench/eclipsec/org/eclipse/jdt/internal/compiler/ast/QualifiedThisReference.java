...
public class QualifiedThisReference extends ThisReference {
	...
	public void generateCode(
		...
		if (valueRequired) {
			if ((bits & DepthMASK) != 0) {
				...
				codeStream.generateOuterAccess(emulationPath, (/*@OwnPar*/ /*@NoRep*/ QualifiedThisReference)this, this.currentCompatibleType, currentScope);
			} else {
	...
	public TypeBinding resolveType(BlockScope scope) {
		...
		if (this.currentCompatibleType == null) {
			scope.problemReporter().noSuchEnclosingInstance(type, (/*@OwnPar*/ /*@NoRep*/ QualifiedThisReference)this, false);
	...
	public void traverse(
		...
		if (visitor.visit((/*@OwnPar*/ /*@NoRep*/ QualifiedThisReference)this, blockScope)) {
			qualification.traverse(visitor, blockScope);
		}
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ QualifiedThisReference)this, blockScope);
	}
}
