...
public class CompoundAssignment extends Assignment implements OperatorIds {
	...
	public FlowInfo analyseCode(BlockScope currentScope, FlowContext flowContext, FlowInfo flowInfo) {
		...
		return  ((Reference) lhs).analyseAssignment(currentScope, flowContext, flowInfo, (/*@OwnPar*/ /*@NoRep*/ CompoundAssignment)this, true).unconditionalInits();
	}
	...
	public TypeBinding resolveType(BlockScope scope) {
		...
		if (restrainUsageToNumericTypes() && !lhsType.isNumericType()) {
			scope.problemReporter().operatorOnlyValidOnNumericType((/*@OwnPar*/ /*@NoRep*/ CompoundAssignment)this, lhsType, expressionType);
			return null;
		}
		...
		if (lhsID > 15 || expressionID > 15) {
			if (lhsID != T_JavaLangString) { // String += Thread is valid whereas Thread += String  is not
				scope.problemReporter().invalidOperator((/*@OwnPar*/ /*@NoRep*/ CompoundAssignment)this, lhsType, expressionType);
				return null;
			}
		...
		if (unboxedLhs) scope.problemReporter().autoboxing((/*@OwnPar*/ /*@NoRep*/ CompoundAssignment)this, lhsType, originalLhsType);
	...
	public void traverse(ASTVisitor visitor, BlockScope scope) {
		if (visitor.visit((/*@OwnPar*/ /*@NoRep*/ CompoundAssignment)this, scope)) {
			lhs.traverse(visitor, scope);
			expression.traverse(visitor, scope);
		}
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ CompoundAssignment)this, scope);
	}
}
