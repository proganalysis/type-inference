...
public RecoveredElement add(AbstractMethodDeclaration methodDeclaration, int bracketBalanceValue) {
	...
	RecoveredMethod element = new RecoveredMethod(methodDeclaration, (/*@OwnPar*/ /*@NoRep*/ RecoveredType)this, bracketBalanceValue, this.recoveringParser);
	...
	return (/*@OwnPar*/ /*@NoRep*/ RecoveredType)this;
}
...
public RecoveredElement add(FieldDeclaration fieldDeclaration, int bracketBalanceValue) {
	...
	switch (fieldDeclaration.getKind()) {
		...
		case AbstractVariableDeclaration.ENUM_CONSTANT:
			element = new RecoveredField(fieldDeclaration, (/*@OwnPar*/ /*@NoRep*/ RecoveredType)this, bracketBalanceValue);
			break;
		case AbstractVariableDeclaration.INITIALIZER:
			element = new RecoveredInitializer(fieldDeclaration, (/*@OwnPar*/ /*@NoRep*/ RecoveredType)this, bracketBalanceValue);
			break;
		default:
...
public RecoveredElement add(TypeDeclaration memberTypeDeclaration, int bracketBalanceValue) {
	...
	RecoveredType element = new RecoveredType(memberTypeDeclaration, (/*@OwnPar*/ /*@NoRep*/ RecoveredType)this, bracketBalanceValue);
