...
public class ForeachStatement extends Statement {
	...
	public FlowInfo analyseCode(
		...
		// process the action
		LoopingFlowContext loopingContext = new LoopingFlowContext(flowContext, (/*@OwnPar*/ /*@NoRep*/ ForeachStatement)this, breakLabel, continueLabel, scope);
	...
	public void traverse(
		...
		if (visitor.visit((/*@OwnPar*/ /*@NoRep*/ ForeachStatement)this, blockScope)) {
		...
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ ForeachStatement)this, blockScope);
	}
}
