...
public class Compiler implements ITypeRequestor, ProblemSeverities {
	...
	// name lookup
	public /*@RepOwn*/ LookupEnvironment lookupEnvironment;
	...
	public Compiler(
		...
		this.lookupEnvironment =
			new LookupEnvironment((/*@OwnPar*/ /*@NoRep*/ Compiler)this, this.options, this.problemReporter, environment);
		initializeParser();
	}
	...
	public Compiler(
		...
		this.lookupEnvironment = new LookupEnvironment((/*@OwnPar*/ /*@NoRep*/ Compiler)this, this.options, problemReporter, environment);
		initializeParser();
	}
...
//		    System.out.println();
	 ...
	 */
	public void accept(/*@NoRep*/ ISourceType[] sourceTypes, PackageBinding packageBinding, AccessRestriction accessRestriction) {
	 ...
	 */
	public void compile(/*@NoRep*/ org.eclipse.jdt.internal.compiler.env.ICompilationUnit /*@OwnOwn*/ [] sourceUnits) {
