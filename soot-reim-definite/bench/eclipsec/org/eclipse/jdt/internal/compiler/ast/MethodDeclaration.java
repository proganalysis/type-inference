...
public class MethodDeclaration extends AbstractMethodDeclaration {
		...
		try {
			...
			if (!this.binding.isUsed() && 
				...
				if (!classScope.referenceCompilationUnit().compilationResult.hasSyntaxError) {
					scope.problemReporter().unusedPrivateMethod((/*@OwnPar*/ /*@NoRep*/ MethodDeclaration)this);
				}
			}
			...
			ExceptionHandlingFlowContext methodContext =
				new ExceptionHandlingFlowContext(
					...
					(/*@OwnPar*/ /*@NoRep*/ MethodDeclaration)this,
			...
			if ((returnTypeBinding == VoidBinding) || isAbstract()) {
				...
				if (flowInfo != FlowInfo.DEAD_END) { 
					scope.problemReporter().shouldReturn(returnTypeBinding, (/*@OwnPar*/ /*@NoRep*/ MethodDeclaration)this);
				}
			}
			// check unreachable catch blocks
			methodContext.complainIfUnusedExceptionHandlers((/*@OwnPar*/ /*@NoRep*/ MethodDeclaration)this);
		} catch (AbortMethod e) {
	...
	public void parseStatements(Parser parser, CompilationUnitDeclaration unit) {
		...
		if (ignoreFurtherInvestigation)
			return;
		parser.parse((/*@OwnPar*/ /*@NoRep*/ MethodDeclaration)this, unit);
	}
	...
	public void resolveStatements() {
		...
		if (CharOperation.equals(this.scope.enclosingSourceType().sourceName, selector)) {
			this.scope.problemReporter().methodWithConstructorName((/*@OwnPar*/ /*@NoRep*/ MethodDeclaration)this);
		}
		...
		checkOverride: {
			...
			if (hasOverrideAnnotation) {
				if ((bindingModifiers & ExtraCompilerModifiers.AccOverriding) == 0 || isInterfaceMethod)
					...
					this.scope.problemReporter().methodMustOverride((/*@OwnPar*/ /*@NoRep*/ MethodDeclaration)this);					
				...
				this.scope.problemReporter().missingOverrideAnnotation((/*@OwnPar*/ /*@NoRep*/ MethodDeclaration)this);
			}
		}
				...
				if ((this.modifiers & ExtraCompilerModifiers.AccSemicolonBody) != 0) {
					if ((this.modifiers & ClassFileConstants.AccNative) == 0)
						if ((this.modifiers & ClassFileConstants.AccAbstract) == 0)
							this.scope.problemReporter().methodNeedBody((/*@OwnPar*/ /*@NoRep*/ MethodDeclaration)this);
				} else {
					// the method HAS a body --> abstract native modifiers are forbiden
					if (((this.modifiers & ClassFileConstants.AccNative) != 0) || ((this.modifiers & ClassFileConstants.AccAbstract) != 0))
						this.scope.problemReporter().methodNeedingNoBody((/*@OwnPar*/ /*@NoRep*/ MethodDeclaration)this);
				}
		}
	...
	public void traverse(
		...
		if (visitor.visit((/*@OwnPar*/ /*@NoRep*/ MethodDeclaration)this, classScope)) {
		...
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ MethodDeclaration)this, classScope);
	}
	public TypeParameter[] typeParameters() {
