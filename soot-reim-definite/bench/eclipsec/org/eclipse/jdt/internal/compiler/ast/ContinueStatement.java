...
public class ContinueStatement extends BranchStatement {
	...
	public FlowInfo analyseCode(
		...
		if (targetContext == null) {
			if (label == null) {
				currentScope.problemReporter().invalidContinue((/*@OwnPar*/ /*@NoRep*/ ContinueStatement)this);
			} else {
				currentScope.problemReporter().undefinedLabel((/*@OwnPar*/ /*@NoRep*/ ContinueStatement)this); 
			}
	...
	public void traverse(
		...
		visitor.visit((/*@OwnPar*/ /*@NoRep*/ ContinueStatement)this, blockScope);
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ ContinueStatement)this, blockScope);
	}
}
