...
public class JavadocSingleTypeReference extends SingleTypeReference {
	...
	protected void reportInvalidType(Scope scope) {
		scope.problemReporter().javadocInvalidType((/*@OwnPar*/ /*@NoRep*/ JavadocSingleTypeReference)this, this.resolvedType, scope.getDeclarationModifiers());
	}
	protected void reportDeprecatedType(Scope scope) {
		scope.problemReporter().javadocDeprecatedType(this.resolvedType, (/*@OwnPar*/ /*@NoRep*/ JavadocSingleTypeReference)this, scope.getDeclarationModifiers());
	}
	...
	public void traverse(ASTVisitor visitor, BlockScope scope) {
		visitor.visit((/*@OwnPar*/ /*@NoRep*/ JavadocSingleTypeReference)this, scope);
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ JavadocSingleTypeReference)this, scope);
	}
