...
public class ClassLiteralAccess extends Expression {
	...
	public TypeBinding resolveType(BlockScope scope) {
		...
		if (targetType.isArrayType()
			...
			scope.problemReporter().cannotAllocateVoidArray((/*@OwnPar*/ /*@NoRep*/ ClassLiteralAccess)this);
			return null;
		} else if (targetType.isTypeVariable()) {
			scope.problemReporter().illegalClassLiteralForTypeVariable((TypeVariableBinding)targetType, (/*@OwnPar*/ /*@NoRep*/ ClassLiteralAccess)this);
		}
	...
	public void traverse(
		...
		if (visitor.visit((/*@OwnPar*/ /*@NoRep*/ ClassLiteralAccess)this, blockScope)) {
			type.traverse(visitor, blockScope);
		}
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ ClassLiteralAccess)this, blockScope);
	}
}
