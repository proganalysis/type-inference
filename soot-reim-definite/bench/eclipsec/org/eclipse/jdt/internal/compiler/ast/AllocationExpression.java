...
public class AllocationExpression extends Expression implements InvocationSite {
	...
	public FlowInfo analyseCode(
		...
		if (((thrownExceptions = this.binding.thrownExceptions).length) != 0) {
			...
			flowContext.checkExceptionHandlers(
				thrownExceptions,
				(/*@OwnPar*/ /*@NoRep*/ AllocationExpression)this,
				flowInfo,
				currentScope);
		}
			...
			if (syntheticArguments != null) 
				for (int i = 0, count = syntheticArguments.length; i < count; i++){
					...
					if (targetLocal.declaration != null && !flowInfo.isDefinitelyAssigned(targetLocal)){
						currentScope.problemReporter().uninitializedLocalVariable(targetLocal, (/*@OwnPar*/ /*@NoRep*/ AllocationExpression)this);
					}
				}
		}
	}
	...
	public void manageSyntheticAccessIfNecessary(BlockScope currentScope, FlowInfo flowInfo) {
		...
		if (this.codegenBinding.isPrivate()
			...
			if (currentScope.compilerOptions().isPrivateConstructorAccessChangingVisibility) {
				...
				currentScope.problemReporter().needToEmulateMethodAccess(this.codegenBinding, (/*@OwnPar*/ /*@NoRep*/ AllocationExpression)this);
			}
		}
	}
	...
	public TypeBinding resolveType(BlockScope scope) {
		...
		if (arguments != null) {
			...
			if (argHasError) {
				if (this.resolvedType instanceof ReferenceBinding) {
					...
					this.binding = scope.findMethod((ReferenceBinding) this.resolvedType, TypeConstants.INIT, pseudoArgs, (/*@OwnPar*/ /*@NoRep*/ AllocationExpression)this);
				}
		...
		if (!(binding = scope.getConstructor(allocationType, argumentTypes, (/*@OwnPar*/ /*@NoRep*/ AllocationExpression)this)).isValidBinding()) {
			if (binding.declaringClass == null)
				binding.declaringClass = allocationType;
			scope.problemReporter().invalidConstructor((/*@OwnPar*/ /*@NoRep*/ AllocationExpression)this, binding);
			return this.resolvedType;
		}
		if (isMethodUseDeprecated(binding, scope, true))
			scope.problemReporter().deprecatedMethod(binding, (/*@OwnPar*/ /*@NoRep*/ AllocationExpression)this);
		checkInvocationArguments(scope, null, allocationType, this.binding, this.arguments, argumentTypes, argsContainCast, (/*@OwnPar*/ /*@NoRep*/ AllocationExpression)this);
	...
	public void traverse(ASTVisitor visitor, BlockScope scope) {
		...
		if (visitor.visit((/*@OwnPar*/ /*@NoRep*/ AllocationExpression)this, scope)) {
			if (this.typeArguments != null) {
		...
		visitor.endVisit((/*@OwnPar*/ /*@NoRep*/ AllocationExpression)this, scope);
	}
}
