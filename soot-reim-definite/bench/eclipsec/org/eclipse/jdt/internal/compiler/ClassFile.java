...
public class ClassFile
	...
	public static void writeToDisk(
		...
		/*@RepRep*/ BufferedOutputStream output = null;
	...
	public /*@OwnPar*/ CodeStream codeStream;
	public /*@OwnPar*/ ConstantPool constantPool;
	...
	public ClassFile(
		...
		headerOffset += 2;
		constantPool = new ConstantPool((/*@OwnPar*/ /*@NoRep*/ ClassFile)this);
		...
		codeStream = new CodeStream((/*@OwnPar*/ /*@NoRep*/ ClassFile)this, this.targetJDK);
	...
	private void addMissingAbstractProblemMethod(MethodDeclaration methodDeclaration, MethodBinding methodBinding, IProblem problem, CompilationResult compilationResult) {
		...
		codeStream.init((/*@OwnPar*/ /*@NoRep*/ ClassFile)this);
	 ...
	 */
	public void addProblemClinit(/*@NoRep*/ org.eclipse.jdt.core.compiler.IProblem /*@OwnOwn*/ [] problems) {
		...
		int codeAttributeOffset = contentsOffset;
		generateCodeAttributeHeader();
		codeStream.resetForProblemClinit((/*@OwnPar*/ /*@NoRep*/ ClassFile)this);
	...
	public void addProblemConstructor(
		...
		int codeAttributeOffset = contentsOffset;
		generateCodeAttributeHeader();
		codeStream.reset(method, (/*@OwnPar*/ /*@NoRep*/ ClassFile)this);
		String problemString = "" ; //$NON-NLS-1$
		int problemLine = 0;
		if (problems != null) {
			int max = problems.length;
	...
	public void addProblemConstructor(
		AbstractMethodDeclaration method,
		MethodBinding methodBinding,
		/*@NoRep*/ org.eclipse.jdt.core.compiler.IProblem /*@OwnOwn*/ [] problems,
		int savedOffset) {
	...
	public void completeCodeAttribute(int codeAttributeOffset) {
		...
		if (codeStream.generateLocalVariableTableAttributes) {
			...
			/*@NoRep*/ org.eclipse.jdt.internal.compiler.lookup.LocalVariableBinding /*@RepRep*/ [] genericLocalVariables = null;
	...
	public void completeCodeAttributeForProblemMethod(
		...
		if (codeStream.generateLocalVariableTableAttributes) {
			...
			/*@NoRep*/ org.eclipse.jdt.internal.compiler.lookup.TypeBinding /*@RepRep*/ [] genericArgumentsTypeBindings = null;
	...
	public ClassFile outerMostEnclosingClassFile() {
		/*@OwnPar*/ ClassFile current = (/*@OwnPar*/ /*@NoRep*/ ClassFile)this;
	...
	public void recordEnclosingTypeAttributes(ReferenceBinding binding) {
		...
		/*@NoRep*/ org.eclipse.jdt.internal.compiler.lookup.ReferenceBinding /*@RepRep*/ [] enclosingTypes;
		if (depth >= 2) {
