...
private /*@RepRep*/ ObjectVector referencedTypes;
private /*@RepRep*/ ObjectVector referencedSuperTypes;

/*@RepRep*/ HashtableOfType constantPoolNameUsage;

public CompilationUnitScope(CompilationUnitDeclaration unit, /*@NoRep*/ LookupEnvironment environment) {
	super(COMPILATION_UNIT_SCOPE, null);
	this.environment = environment;
	this.referenceContext = unit;
	unit.scope = (/*@OwnPar*/ /*@NoRep*/ CompilationUnitScope)this;
...
void buildTypeBindings(AccessRestriction accessRestriction) {
	...
	nextType: for (int i = 0; i < typeLength; i++) {
		...
		/*@RepNorep*/ ClassScope child = new ClassScope((/*@OwnPar*/ /*@NoRep*/ CompilationUnitScope)this, typeDecl);
...
void faultInImports() {
	...
	int numberOfStatements = referenceContext.imports.length;
	/*@RepRep*/ HashtableOfType typesBySimpleNames = null;
	for (int i = 0; i < numberOfStatements; i++) {
	...
	nextImport : for (int i = 0; i < numberOfStatements; i++) {
		...
		if (importReference.onDemand) {
			...
			if (importBinding instanceof ReferenceBinding || conflictingType != null) {
				...
				if (importReference.isTypeUseDeprecated(referenceBinding, (/*@OwnPar*/ /*@NoRep*/ CompilationUnitScope)this))
...
MethodBinding findStaticMethod(ReferenceBinding currentType, char[] selector) {
	if (!currentType.canBeSeenBy((/*@OwnPar*/ /*@NoRep*/ CompilationUnitScope)this))
		return null;
...
Binding resolveSingleImport(/*@OwnOwn*/ ImportBinding importBinding) {
