...
public final class HashtableOfType {
	...
	public char /*@NoRep*/ [] /*@NoRep*/ [] keyTable;
...
private void rehash() {
	/*@RepRep*/ HashtableOfType newHashtable = new HashtableOfType(elementSize < 100 ? 100 : elementSize * 2); // double the number of expected elements
	char[] currentKey;
