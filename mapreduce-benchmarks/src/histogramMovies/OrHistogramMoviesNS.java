...
public class OrHistogramMoviesNS extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		JobConf conf = new JobConf(OrHistogramMoviesNS.class);
	...
	public static void main(String[] args) throws Exception {
		int ret = ToolRunner.run(new OrHistogramMoviesNS(), args);
		System.exit(ret);
	}
}
