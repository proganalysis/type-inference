 ...
 * <p>
 * <cite> G. Bilardi and A. Nicolau, "Adaptive Bitonic Sorting: An optimal
 * parallel algorithm for shared-memory machines." SIAM J. Comput.
 * 18(2):216-228, 1998. </cite>
 * <p>
 * The benchmarks sorts N numbers where N is a power of 2. If the user provides
 * an input value that is not a power of 2, then we use the nearest power of 2
 * value that is less than the input value.
 **/
public class BiSort {
	/**
	...
	public static final void main(String args[]) {
		...
		if (printMsgs) {
			...
			System.out.println("Total: " + (System.currentTimeMillis() - start2)/1000.0);
			System.out.println("Running time: " + (System.currentTimeMillis() - end2 - Value.initialTime)/1000.0);
		}
