...
public class Value {
	...
	/**
	 * Create a random tree of value to be sorted using the bitonic sorting
	 * algorithm.
	 *
	 * @param size
	 *            the number of values to create.
	 * @param seed
	 ...
	 *
	 * @param spr_val
	 *            the "spare" value in the algorithm.
	 * @param direction
	 *            the direction of the sort (forward or backward)
	...
	/**
	 * Perform the merge part of the bitonic sort. The merge part does the
	 * actualy sorting.
	 * 
	 * @param spr_val
	 *            the "spare" value in the algorithm.
	 ...
	 * 
	 * @param n
	 *            the other subtree involved in the swap.
	 **/
	...
	public void inOrder() {
		...
		initialTime += System.currentTimeMillis() - start;
		if (right != null)
			right.inOrder();
	}

	/**
	 * A random generator. The original Olden benchmark uses its own random
	 * generator. We use the same one in the Java version.
	 * 
	 ...
	 * 
	 * @param seed
	 *            the current random no. seed
	 * @param n
	 *            the number of numbers to skip
	 **/
