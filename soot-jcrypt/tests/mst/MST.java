 ...
 * benchmark computes the minimum spanning tree of a graph using Bentley's
 * algorithm.
 * <p>
 * <cite> J. Bentley.
 * "A Parallel Algorithm for Constructing Minimum Spanning Trees" J. of
 * Algorithms, 1:51-59, 1980. </cite>
 * <p>
 * As with the original C version, this one uses its own implementation of
 * hashtable.
 **/
public class MST {
	/**
	 ...
	 **/
	private static final void parseCmdLine(/* @BOT */ String args/* @BOT */ []) {
		int i = 0;
		String arg;
