...
public class TreeNode {
	...
	/**
	 * Construct a subtree with the specified number of levels. We recursively
	 * call the constructor to create the tree.
	 * 
	 * @param levels
	 *            the number of levels in the subtree
	 **/
	...
	/**
	 * Add the value of this node with the cumulative values of the children of
	 * this node.
	 * 
