...
public class HashMap<K,V>
    ...
    @PolyreadThis public int size() { throw new RuntimeException("skeleton method"); }
    ...
    @PolyreadThis public Collection<V> values()  { throw new RuntimeException("skeleton method"); }
