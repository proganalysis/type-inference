...
public abstract class BaseCommandController extends AbstractController {
	 ...
	 * @see #createCommand
	 */
	protected /*-@Secret*/ Object getCommand(HttpServletRequest request) throws Exception {
	 ...
	 */
	protected final /*-@Secret*/ Object createCommand() throws Exception {
...
//    }
	 ...
	 */
	protected final boolean checkCommand(/*-@Secret*/ Object command) {
	 ...
	 */
	protected final ServletRequestDataBinder bindAndValidate(HttpServletRequest request, /*-@Secret*/ Object command)
			throws Exception {
	 ...
	 * @see #initBinder
	 */
	protected ServletRequestDataBinder createBinder(HttpServletRequest request, /*-@Secret*/ Object command)
	    throws Exception {
	 ...
	 */
	protected void onBind(HttpServletRequest request, /*-@Secret*/ Object command, BindException errors) throws Exception {
	 ...
	 */
	protected void onBind(HttpServletRequest request, /*-@Secret*/ Object command) throws Exception {
	}
	 ...
	 * @return whether to suppress validation for the given request
	 */
	protected boolean suppressValidation(HttpServletRequest request, /*-@Secret*/ Object command, BindException errors) {
	 ...
	 */
	protected void onBindAndValidate(HttpServletRequest request, /*-@Secret*/ Object command, BindException errors)
			throws Exception {
	}
