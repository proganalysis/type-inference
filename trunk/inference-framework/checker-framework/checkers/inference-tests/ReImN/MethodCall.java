...
public class MethodCall {
    ...
    private void setF(/*@MutMut*/ MethodCall this, MethodCall mc) /*mutable*/ {
        this.f = mc;
    }

    private void setG(/*@MutMut*/ MethodCall this, MethodCall mc) /*mutable*/ {
        this.g = mc;
    }
    ...
    private void baz(/*@MutMut*/ MethodCall this, MethodCall mx) /*mutable*/ {
        this.setG(mx);
    }
