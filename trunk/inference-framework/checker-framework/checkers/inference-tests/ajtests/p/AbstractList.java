...
public abstract class AbstractList extends AbstractCollection implements List {
     ...
     */
    public boolean addAll(int index, /*unitfor(L)*/ /*@Aliased*/ Collection c/*L=this.L*/) {
	...
	return (Iterator) new AbstractList_Itr(this);
    }
     ...
     */
    public /*Aliased*/ ListIterator listIterator() {
     ...
     * @see #modCount
     */
    public /*Aliased*/ ListIterator listIterator(final int index) {
	if (index<0 || index>size())
	  throw new IndexOutOfBoundsException("Index: "+index);

	return (ListIterator) new AbstractList_ListItr(this, index);
    }
    ...
    public /*Aliased*/ List subList(int fromIndex, int toIndex) {
        return (List) (this instanceof RandomAccess ?
		       new AbstractList_RandomAccessSubList(this, fromIndex, toIndex) :
		       new AbstractList_SubList(this, fromIndex, toIndex));
    }
