...
public abstract class AnnotatedTypeMirror {
    ...
    public void addAnnotation(AnnotationMirror a) {
        if (a == null) {
//        	throw new RuntimeException("AnnotatedTypeMirror.addAnnotation: null is not a valid annotation.");
//            throw new SourceChecker.CheckerError("AnnotatedTypeMirror.addAnnotation: null is not a valid annotation.");
        	System.out.println("WARN: AnnotatedTypeMirror.addAnnotation: null is not a valid annotation.");
        }
...
//                    throw new SourceChecker.CheckerError("AnnotatedTypeMirror.fixupBoundAnnotations: default annotation on lower bound ( " + lAnnos + ") is inconsistent with explicit upper bound: " + this);
                    System.err.println("AnnotatedTypeMirror.fixupBoundAnnotations: default annotation on lower bound ( " + lAnnos + ") is inconsistent with explicit upper bound: " + this);
                }
            }
        }
