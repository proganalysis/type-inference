 ...
 *
 */
public class ReimFlowAnnotatedTypeFactory extends
		InferenceAnnotatedTypeFactory {
	
	private ReimFlowChecker checker;
	
	public ReimFlowAnnotatedTypeFactory(ReimFlowChecker checker,
	...
	private void annotateMethod(ExecutableElement methodElt, 
		...
		if (fromLibrary && checker.isPolyLibrary()) {
			...
			// FIXME: move it to ReimFlowChecker.fillAllPossibleAnnos
