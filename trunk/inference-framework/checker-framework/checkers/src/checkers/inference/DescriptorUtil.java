 ...
 * @author huangw5 handle L and [ 
 */
public class DescriptorUtil {
    private static Map<String, String> _paramTypeMap = new HashMap<String, String>();

    private static Map<String, String> _returnTypeMap = new HashMap<String, String>();
...
//        _paramTypeMap.put("array reference", "[");
        ...
        // WEI: improved by huangw5@cs.rpi.edu
    ...
    public static String convert(String javadocSig, String javadocReturnType) {
        ...
        while (st.hasMoreTokens()) {
            ...
            int i = sigElement.length() - 1;
            while (sigElement.charAt(i) == ']') {
            	jvmBuff.append("[");
            	i = i - 2;
            }
            sigElement = sigElement.substring(0, i + 1);
            ...
            if (_paramTypeMap.containsKey(sigElement)) {
            	...
            	// reference type
            	jvmBuff.append("L");
            	jvmBuff.append(sigElement.replace('.', '/') + ";");
            }
        }
        jvmBuff.append(")");
        
        
        int i = javadocReturnType.length() - 1;
        while (javadocReturnType.charAt(i) == ']') {
        	jvmBuff.append("[");
        	i = i - 2;
        }
        javadocReturnType = javadocReturnType.substring(0, i + 1);
        
        if (_paramTypeMap.containsKey(javadocReturnType)) {
            jvmBuff.append(_paramTypeMap.get(javadocReturnType));
        }
        else {
        	// reference type
        	jvmBuff.append("L");
        	jvmBuff.append(javadocReturnType.replace('.', '/') + ";");
        }
