...
/*internal*/public interface Set extends Collection {
    // Query Operations
     ...
     * @see    #contains(Object)
     */
    boolean containsAll(/*unitfor(L)*/ /*@Aliased*/ Collection/*L=this.L*/ c);
     ...
     * @see #add(Object)
     */
    boolean addAll(/*unitfor(L)*/ /*@Aliased*/ Collection/*L=this.L*/ c);
     ...
     * @see #remove(Object)
     */
    boolean retainAll(/*unitfor(L)*/ /*@Aliased*/ Collection/*L=this.L*/ c);
     ...
     * @see    #remove(Object)
     */
    boolean removeAll(/*unitfor(L)*/ /*@Aliased*/ Collection/*L=this.L*/ c);
