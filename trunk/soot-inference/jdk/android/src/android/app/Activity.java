...
public class Activity extends android.view.ContextThemeWrapper implements android.view.LayoutInflater.Factory2, android.view.Window.Callback, android.view.KeyEvent.Callback, android.view.View.OnCreateContextMenuListener, android.content.ComponentCallbacks2 {
    ...
    public void setResult(int arg0, android.content.Intent arg1) { throw new RuntimeException("skeleton method"); }
    ...
    public void startIntentSender(android.content.IntentSender arg0, android.content.Intent arg1, int arg2, int arg3, int arg4) throws android.content.IntentSender.SendIntentException { throw new RuntimeException("skeleton method"); }
    public void startIntentSender(android.content.IntentSender arg0, android.content.Intent arg1, int arg2, int arg3, int arg4, android.os.Bundle arg5) throws android.content.IntentSender.SendIntentException { throw new RuntimeException("skeleton method"); }
    public void startIntentSenderForResult(android.content.IntentSender arg0, int arg1, android.content.Intent arg2, int arg3, int arg4, int arg5) throws android.content.IntentSender.SendIntentException { throw new RuntimeException("skeleton method"); }
    public void startIntentSenderForResult(android.content.IntentSender arg0, int arg1, android.content.Intent arg2, int arg3, int arg4, int arg5, android.os.Bundle arg6) throws android.content.IntentSender.SendIntentException { throw new RuntimeException("skeleton method"); }
    public void startIntentSenderFromChild(android.app.Activity arg0, android.content.IntentSender arg1, int arg2, android.content.Intent arg3, int arg4, int arg5, int arg6) throws android.content.IntentSender.SendIntentException { throw new RuntimeException("skeleton method"); }
    public void startIntentSenderFromChild(android.app.Activity arg0, android.content.IntentSender arg1, int arg2, android.content.Intent arg3, int arg4, int arg5, int arg6, android.os.Bundle arg7) throws android.content.IntentSender.SendIntentException { throw new RuntimeException("skeleton method"); }
    public void startManagingCursor(android.database.Cursor arg0) { throw new RuntimeException("skeleton method"); }
    public boolean startNextMatchingActivity(android.content.Intent arg0) { throw new RuntimeException("skeleton method"); }
    public boolean startNextMatchingActivity(android.content.Intent arg0, android.os.Bundle arg1) { throw new RuntimeException("skeleton method"); }
