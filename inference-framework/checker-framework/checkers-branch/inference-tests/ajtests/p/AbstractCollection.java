...
public abstract class AbstractCollection implements Collection {
    ...
    public AliasedIterator externalIterator() {
    	return new AliasedIterator_1(iterator());
    }
     ...
     * @see #contains(Object)
     */
    public boolean containsAll(/*@Aliased*/ Collection c) {
     ...
     * @see #contains(Object)
     */
    public boolean removeAll(/*@Aliased*/ Collection c) {
	boolean modified = false;
	Iterator e = iterator();
	while (e.hasNext()) {
     ...
     * @see #contains(Object)
     */
    public boolean retainAll(/*@Aliased*/ Collection c) {
	boolean modified = false;
	Iterator e = iterator();
	while (e.hasNext()) {
	    if (!c.contains(e.next())) {
