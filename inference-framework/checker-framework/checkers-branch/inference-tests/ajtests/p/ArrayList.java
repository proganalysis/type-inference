...
/*internal*/public class ArrayList extends AbstractList
        implements List, RandomAccess, Cloneable, java.io.Serializable
{
     ...
     */
    /*atomic(L)*/ private transient /*@NonAliased*/ Object [] elementData/*this.L[]*/;
	...
	super();
        if (initialCapacity < 0)
            throw new IllegalArgumentException("Illegal Capacity: "+
                                               initialCapacity);
	this.elementData = new Object/*this.L[]*/[initialCapacity];
    }
     ...
     */
    public ArrayList(/*unitfor(L)*/ /*@Aliased*/ Collection/*L=this.L*/ c) {
        size = c.size();
        // Allow 10% room for growth
        elementData = new Object/*this.L[]*/[
                      (int)Math.min((size*110L)/100,Integer.MAX_VALUE)]; 
        c.toArray((Object[]) elementData);
    }  
	...
	if (size < oldCapacity) {
	    Object[] oldData/*this.L[]*/ = elementData;
	    elementData = new Object/*this.L[]*/[size];
	...
	if (minCapacity > oldCapacity) {
	    ...
	    elementData = new Object/*this.L[]*/[newCapacity];
	    System.arraycopy(oldData, 0, elementData, 0, size);
	} 
    }
...
// FT: commented out: clone() is generated automatically by our compiler.
//    /**
...
//    }
	...
	s.defaultReadObject();
        ...
        Object/*this.L*/[] a = elementData = new Object/*this.L[]*/[arrayLength];
