...
class Cookie implements Cloneable, Serializable {
    ...
    public /*-@Secret*/ String getComment() { throw new RuntimeException("skeleton method"); }
    public void setDomain(String arg0) { throw new RuntimeException("skeleton method"); }
    public /*-@Secret*/ String getDomain() { throw new RuntimeException("skeleton method"); }
    ...
    public /*-@Secret*/ String getName() { throw new RuntimeException("skeleton method"); }
    public void setValue(String arg0) { throw new RuntimeException("skeleton method"); }
    public /*-@Secret*/ String getValue() { throw new RuntimeException("skeleton method"); }
