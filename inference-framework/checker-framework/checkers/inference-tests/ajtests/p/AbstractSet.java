...
/*internal*/public abstract class AbstractSet extends AbstractCollection implements Set {
    /**
	...
	if (!(o instanceof Set))
	    return false;
	Collection c/*L=this.L*/ = (/*@Aliased*/Collection/*L=this.L*/) o;
	if (c.size() != size())
	    return false;
        try {
     ...
     * @see #contains(Object)
     */
    public boolean removeAll(/*unitfor(L)*/ /*@Aliased*/ Collection/*L=this.L*/ c) {
        boolean modified = false;

        if (size() > c.size()) {
            for (Iterator i/*I=this.L*/ = c.iterator(); i.hasNext(); )
                modified |= remove(i.next());
        } else {
            for (Iterator i/*I=this.L*/ = iterator(); i.hasNext(); ) {
