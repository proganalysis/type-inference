...
class Runtime {
    ...
    Process exec(/*@Tainted*/ String arg0) throws IOException {throw new RuntimeException("skeleton method");}
    Process exec(/*@Tainted*/ String arg0, String[] arg1) throws IOException {throw new RuntimeException("skeleton method");}
    Process exec(/*@Tainted*/ String arg0, String[] arg1, File arg2) throws IOException {throw new RuntimeException("skeleton method");}
    Process exec(/*@Tainted*/ String/*@Tainted*/ [] arg0) throws IOException {throw new RuntimeException("skeleton method");}
    Process exec(/*@Tainted*/ String/*@Tainted*/ [] arg0, String[] arg1) throws IOException {throw new RuntimeException("skeleton method");}
    Process exec(/*@Tainted*/ String/*@Tainted*/ [] arg0, String[] arg1, File arg2) throws IOException {throw new RuntimeException("skeleton method");}
    ...
    void load(/*@Tainted*/ String arg0) {throw new RuntimeException("skeleton method");}
    void loadLibrary(/*@Tainted*/ String arg0) {throw new RuntimeException("skeleton method");}
