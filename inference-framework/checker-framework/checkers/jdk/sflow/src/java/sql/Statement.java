...
public interface Statement extends Wrapper {
    ResultSet executeQuery(/*@Safe*/ String arg0) throws SQLException;
    int executeUpdate(/*@Safe*/ String arg0) throws SQLException;
    ...
    boolean execute(/*@Safe*/ String arg0) throws SQLException;
    ...
    void addBatch(/*@Safe*/ String arg0) throws SQLException;
    void clearBatch() throws SQLException;
    int[] executeBatch() throws SQLException;
    Connection getConnection() throws SQLException;
    boolean getMoreResults(int arg0) throws SQLException;
    ResultSet getGeneratedKeys() throws SQLException;
    int executeUpdate(/*@Safe*/ String arg0, int arg1) throws SQLException;
    int executeUpdate(/*@Safe*/ String arg0, int[] arg1) throws SQLException;
    int executeUpdate(/*@Safe*/ String arg0, String[] arg1) throws SQLException;
    boolean execute(/*@Safe*/ String arg0, int arg1) throws SQLException;
    boolean execute(/*@Safe*/ String arg0, int[] arg1) throws SQLException;
    boolean execute(/*@Safe*/ String arg0, String[] arg1) throws SQLException;
