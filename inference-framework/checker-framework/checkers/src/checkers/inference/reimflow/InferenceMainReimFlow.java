 ...
 *
 */
public class InferenceMainReimFlow extends InferenceMain {
...
//			PrintWriter pw;
//			try {
//				pw = new PrintWriter(InferenceMainReimFlow.outputDir
...
//				((ReimFlowChecker) inferenceChecker).setInferLibrary(true);
//			}
		}
		currentExtractor = new MaximalTypingExtractor(inferenceChecker, Reference.getExpReferences(), constraints);
...
//		} 
		...
		// Now we merge the maximal typing for ReimFlow and ReIm 
