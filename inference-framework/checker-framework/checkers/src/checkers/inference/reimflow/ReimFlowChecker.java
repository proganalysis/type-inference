...
import checkers.inference.reimflow.quals.Bottom;
...
import checkers.inference.reimflow.quals.Uncheck;
...
public class ReimFlowChecker extends InferenceChecker {
...
//		System.out.println("INFO: resolveConflict = " + resolveConflict);
	...
	protected MultiGraphFactory createQualifierHierarchyFactory() {
		return new ReimFlowGraphQualifierHierarchy.InferenceGraphFactory(this);
	}
	...
	public BaseTypeVisitor<?> getInferenceVisitor(InferenceChecker checker,
		...
		return new ReimFlowInferenceVisitor((ReimFlowChecker) checker, root);
	}
...
//			}
	...
	private void printAnnoDeclaration(PrintWriter out) {
		...
		out.println();
		out.println("package checkers.inference.reimflow.quals:");
