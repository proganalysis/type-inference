 ...
 * 
 */
public class EnerjConstraintSolver extends AbstractConstraintSolver<EnerjChecker> {
	...
	private EnerjChecker checker;

	private Set<Constraint> constraints;

	public EnerjConstraintSolver(EnerjChecker t) {
		super(t);
		this.checker = t;
