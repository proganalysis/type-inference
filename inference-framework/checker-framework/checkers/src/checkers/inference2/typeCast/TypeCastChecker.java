...
public class TypeCastChecker extends InferenceChecker {
	...
	protected SourceVisitor<?, ?> getInferenceVisitor(
		...
		this.root = root;
		return new TypeCastVisitor(this, root);
	}
	...
	public void printResult() {
		...
		try {
			PrintWriter pw = new PrintWriter(TypeCastMain.outputDirTrans
					+ TypeCastMain.packageName + filename);
			printResult(pw);
			pw.close();
		} catch (Exception e) {
			e.printStackTrace();
