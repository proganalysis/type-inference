...
public interface List extends Collection {
     ...
     * @see #contains(Object)
     */
    boolean containsAll(/*@Aliased*/ Collection c);
     ...
     * @see #add(Object)
     */
    boolean addAll(/*@Aliased*/ Collection c);
     ...
     *		  &lt; 0 || index &gt; size()).
     */
    boolean addAll(int index, /*@Aliased*/ Collection c);
     ...
     * @see #contains(Object)
     */
    boolean removeAll(/*@Aliased*/ Collection c);
     ...
     * @see #contains(Object)
     */
    boolean retainAll(/*@Aliased*/ Collection c);
