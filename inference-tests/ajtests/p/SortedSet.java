...
/*internal*/public interface SortedSet extends Set {
    /**
     ...
     */
    SortedSet/*L=this.L*/ subSet(Object fromElement, Object toElement);
     ...
     */
    SortedSet/*L=this.L*/ headSet(Object toElement);
     ...
     *         specified range of the subSet, headSet, or tailSet.
     */
    SortedSet/*L=this.L*/ tailSet(Object fromElement);
