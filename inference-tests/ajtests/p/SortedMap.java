...
/*internal*/public interface SortedMap extends Map {
    /**
     ...
     *	       <tt>null</tt> keys.
     */
    SortedMap/*M=this.M*/ subMap(Object fromKey, Object toKey);
     ...
     */
    SortedMap/*M=this.M*/ headMap(Object toKey);
     ...
     *	       this sorted map does not tolerate <tt>null</tt> keys.
     */
    SortedMap/*M=this.M*/ tailMap(Object fromKey);
